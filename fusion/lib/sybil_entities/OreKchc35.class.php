 ...
 * @property float $oreGobackDig
 * @property float $oreGobackUse
 ...
 */
class OreKchc35 extends DataEntity {
	protected static $propSpec = array(
		'master' => array(
			'tableName' => 'ore_kchc35',
			'columns' => array(
				'id' => 'id',
				'mineId' => 'mine_id',
				'oreId' => 'ore_id',
				...
				'value' => 'value',
				'oreGobackDig' => 'ore_goback_dig',
				'oreGobackUse' => 'ore_goback_use',
