 ...
 * @property float $complexUserateUsequality
 * @property float $complexUserateSavequality
 * @property float $complexUserateGoback
 * @property float $complexUserateFindback
 * @property float $complexUserateTaste
 ...
 */
class OreZhly35 extends DataEntity {
	protected static $propSpec = array(
		'master' => array(
			'tableName' => 'ore_zhly35',
			'columns' => array(
				'id' => 'id',
				'mineId' => 'mine_id',
				'oreId' => 'ore_id',
