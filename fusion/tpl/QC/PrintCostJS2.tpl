       ...
       <div class='tablebox'>
		...
		<!--startprint-->
			...
			<tr>
		        ...
		        <tr>
		            <td width="125px" >购货单位：</td>
                            <td colspan= 2>{$task.customer.name}</td>
                            <td width="125px">车号</td>
			...
			<div id=shuaxin style="display:none; width:100%; text-align:center; height:50px; padding-top:10px;">
			    <input type=button value=点击返回 onclick="location.href='/QC/QCShoudongList'"></div>
			<!--endprint-->
			  ...
			  <table  align="center"  width="750">
		   	...
		   	<input type="button" onclick="location.href='/QC/QCShoudongList'" value="返回" />
			     </td>
			</tr>
	             </table>
