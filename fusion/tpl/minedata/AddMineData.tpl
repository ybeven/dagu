...
<form name="form" action="/minedata/UploadeExcelMineData/{$mineid}" method="post" enctype="multipart/form-data">
...
<form id="testform"   name="form" action="/minedata/SaveMineData/{$mineid}" method="post" enctype="multipart/form-data">
<div id="tabs">
   <ul>
	...
	<table class="formView" align="center" id="basedata" width='100%'>
			...
			<tr>
				...
				<!--  value="{$basedataArray[0]->basedataBgname}" -->
			...
			<tr>
				...
				<!--  value="{$basedataArray[0]->basedataLimit}"
				value="{$basedataArray[0]->basedataJiqizhi}" -->
			</tr>
			<tr>
				...
				<td class="tdhead">报告出具日期</td><td><input class="datepicker" name="basedataBgdate"></td>
				 <!-- value="{$basedataArray[0]->basedataEstablish}"
value="{$basedataArray[0]->basedataBgdate}"  -->
			</tr>
			<tr>
				...
				<!--  value="{$basedataArray[0]->basedataMinename}"
 value="{$basedataArray[0]->basedataBuildtime}" -->
			</tr>
			<tr>
				<td class="tdhead">企业名称</td><td><input name="basedataCompanyname"></td>
				<!--  value="{$basedataArray[0]->basedataCompanyname}" -->
			...
			<tr>
				...
				<!-- value="{$basedataArray[0]->basedataOwedname}" 
value="{$basedataArray[0]->basedataArea}"  -->
			</tr>
			...
			<tr>
				...
				<!-- {$basedataArray[0]->basedataReward}</textarea> -->
			</tr>
			<tr>
				<!--矿山效益-->
				...
				<!--  value="{$basedataArray[0]->basedataValue}"
value="{$basedataArray[0]->basedataFee}"  -->
			</tr>
   		</table>
   		<table align="center" style="display:none;" class="formView" id="bef3_pre5_basedataValue">
			<tr>
				<td id="t_basedataValue_bef3" class="tdhead">{$basedataArray[0]->basedataJiqizhi-2}年实际值</td><td><input type="text" name="basedataValue_bef3"></td>
				<td id="t_basedataValue_bef2" class="tdhead">{$basedataArray[0]->basedataJiqizhi-1}年实际值</td><td><input name="basedataValue_bef2"></td>
				<!--  value="{$basedata35Array[3][0]}"
value="{$basedata35Array[3][1]}"  -->
		</tr>
		<tr>
				<td id="t_basedataValue_bef1" class="tdhead">{$basedataArray[0]->basedataJiqizhi}年实际值</td><td><input name="basedataValue_bef1"></td>
		</tr>
		<tr>
				<td id="t_basedataValue_pre1" class="tdhead">{$basedataArray[0]->basedataJiqizhi+1}年规划值</td><td><input name="basedataValue_pre1"></td>
				<td id="t_basedataValue_pre1real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+1}年实际值</td><td><input name="basedataValue_pre1real"></td>
		</tr>
		<tr>
				<td id="t_basedataValue_pre2" class="tdhead">{$basedataArray[0]->basedataJiqizhi+2}年规划值</td><td><input name="basedataValue_pre2"></td>
				<td id="t_basedataValue_pre2real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+2}年实际值</td><td><input name="basedataValue_pre2real"></td>
		</tr>
		<tr>
				<td id="t_basedataValue_pre3" class="tdhead">{$basedataArray[0]->basedataJiqizhi+3}年规划值</td><td><input name="basedataValue_pre3"></td>
				<td id="t_basedataValue_pre3real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+3}年实际值</td><td><input name="basedataValue_pre3real"></td>
		</tr>
		<tr>
				<td id="t_basedataValue_pre4" class="tdhead">{$basedataArray[0]->basedataJiqizhi+4}年规划值</td><td><input name="basedataValue_pre4"></td>
				<td id="t_basedataValue_pre4real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+4}年实际值</td><td><input name="basedataValue_pre4real"></td>
		</tr>
		<tr>
				<td id="t_basedataValue_pre5" class="tdhead">{$basedataArray[0]->basedataJiqizhi+5}年规划值</td><td><input name="basedataValue_pre5"></td>
				<td id="t_basedataValue_pre5real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+5}年实际值</td><td><input name="basedataValue_pre5real"></td>	  
		</tr>
		<!-- value="{$basedata35Array[3][2]}" 
value="{$basedata35Array[3][3]}" 
value="{$basedata35Array[3][4]}" 
value="{$basedata35Array[3][5]}" 
value="{$basedata35Array[3][6]}" 
value="{$basedata35Array[3][7]}" 
value="{$basedata35Array[3][8]}" 
 value="{$basedata35Array[3][9]}"
value="{$basedata35Array[3][10]}" 
value="{$basedata35Array[3][11]}" 
value="{$basedata35Array[3][12]}"  -->
	</table>
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_basedataFee">
		<tr>
				<td id="t_basedataFee_bef3" class="tdhead">{$basedataArray[0]->basedataJiqizhi-2}年实际值</td><td><input name="basedataFee_bef3"></td>
				<td id="t_basedataFee_bef2" class="tdhead">{$basedataArray[0]->basedataJiqizhi-1}年实际值</td><td><input name="basedataFee_bef2"></td>
		</tr>
		<tr>
				<td id="t_basedataFee_bef1" class="tdhead">{$basedataArray[0]->basedataJiqizhi}年实际值</td><td><input name="basedataFee_bef1"></td>
		</tr>
		<tr>
				<td id="t_basedataFee_pre1" class="tdhead">{$basedataArray[0]->basedataJiqizhi+1}年规划值</td><td><input name="basedataFee_pre1"></td>
				<td id="t_basedataFee_pre1real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+1}年实际值</td><td><input name="basedataFee_pre1real"></td>
		</tr>
		<tr>
				<td id="t_basedataFee_pre2" class="tdhead">{$basedataArray[0]->basedataJiqizhi+2}年规划值</td><td><input name="basedataFee_pre2"></td>
				<td id="t_basedataFee_pre2real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+2}年实际值</td><td><input name="basedataFee_pre2real"></td>
		</tr>
		<tr>
				<td id="t_basedataFee_pre3" class="tdhead">{$basedataArray[0]->basedataJiqizhi+3}年规划值</td><td><input name="basedataFee_pre3"></td>
				<td id="t_basedataFee_pre3real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+3}年实际值</td><td><input name="basedataFee_pre3real"></td>
		</tr>
		<tr>
				<td id="t_basedataFee_pre4" class="tdhead">{$basedataArray[0]->basedataJiqizhi+4}年规划值</td><td><input name="basedataFee_pre4"></td>
				<td id="t_basedataFee_pre4real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+4}年实际值</td><td><input name="basedataFee_pre4real"></td>
		</tr>
		<tr>
				<td id="t_basedataFee_pre5" class="tdhead">{$basedataArray[0]->basedataJiqizhi+5}年规划值</td><td><input name="basedataFee_pre5"></td>
				<td id="t_basedataFee_pre5real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+5}年实际值</td><td><input name="basedataFee_pre5real"></td>	  
		</tr>
		<!-- value="{$basedata35Array[4][0]}" 
value="{$basedata35Array[4][1]}" 
 value="{$basedata35Array[4][2]}"
value="{$basedata35Array[4][3]}" 
 value="{$basedata35Array[4][4]}"
 value="{$basedata35Array[4][5]}"
 value="{$basedata35Array[4][6]}"
 value="{$basedata35Array[4][7]}"
 value="{$basedata35Array[4][8]}"
 value="{$basedata35Array[4][9]}"
 value="{$basedata35Array[4][10]}"
 value="{$basedata35Array[4][11]}"
 value="{$basedata35Array[4][12]}" -->
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
			...
			<!--  value="{$basedataArray[0]->basedataProfit}"
   value="{$basedataArray[0]->basedataWorker}" -->
		</tr>
	</table>
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_basedataProfit">
		<tr>
			<td id="t_basedataProfit_bef3" class="tdhead">{$basedataArray[0]->basedataJiqizhi-2}年实际值</td><td><input name="basedataProfit_bef3"></td>
			<td id="t_basedataProfit_bef2" class="tdhead">{$basedataArray[0]->basedataJiqizhi-1}年实际值</td><td><input name="basedataProfit_bef2"></td>
		</tr>
		<tr>
			<td id="t_basedataProfit_bef1"class="tdhead">{$basedataArray[0]->basedataJiqizhi}年实际值</td><td><input name="basedataProfit_bef1"></td>
		</tr>
		<tr>
			<td id="t_basedataProfit_pre1" class="tdhead">{$basedataArray[0]->basedataJiqizhi+1}年规划值</td><td><input name="basedataProfit_pre1"></td>
			<td id="t_basedataProfit_pre1real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+1}年实际值</td><td><input name="basedataProfit_pre1real"></td>
		</tr>
		<tr>
			<td id="t_basedataProfit_pre2" class="tdhead">{$basedataArray[0]->basedataJiqizhi+2}年规划值</td><td><input name="basedataProfit_pre2"></td>
			<td id="t_basedataProfit_pre2real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+2}年实际值</td><td><input name="basedataProfit_pre2real"></td>
		</tr>
		<tr>
			<td id="t_basedataProfit_pre3" class="tdhead">{$basedataArray[0]->basedataJiqizhi+3}年规划值</td><td><input name="basedataProfit_pre3"></td>
			<td id="t_basedataProfit_pre3real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+3}年实际值</td><td><input name="basedataProfit_pre3real"></td>
		</tr>
		<tr>
			<td id="t_basedataProfit_pre4" class="tdhead">{$basedataArray[0]->basedataJiqizhi+4}年规划值</td><td><input name="basedataProfit_pre4"></td>
			<td id="t_basedataProfit_pre4real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+4}年实际值</td><td><input name="basedataProfit_pre4real"></td>
		</tr>
		<tr>
			<td id="t_basedataProfit_pre5" class="tdhead">{$basedataArray[0]->basedataJiqizhi+5}年规划值</td><td><input name="basedataProfit_pre5"></td>
			<td id="t_basedataProfit_pre5real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+5}年实际值</td><td><input name="basedataProfit_pre5real"></td>	  
		</tr>
		<!--value="{$basedata35Array[5][0]}" 
value="{$basedata35Array[5][1]}" 
value="{$basedata35Array[5][2]}" 
value="{$basedata35Array[5][3]}" 
value="{$basedata35Array[5][4]}" 
value="{$basedata35Array[5][5]}" 
value="{$basedata35Array[5][6]}" 
 value="{$basedata35Array[5][7]}"
 value="{$basedata35Array[5][8]}"
value="{$basedata35Array[5][9]}" 
value="{$basedata35Array[5][10]}" 
 value="{$basedata35Array[5][11]}"
value="{$basedata35Array[5][12]}"   -->
	</table>
	<table class="formView" align="center" width='100%'>
	<tr>
	...
	<table class="formView" align="center" id="ore" width='100%'>
		...
		<tr>
			...
			<!-- value="{$basedataArray[0]->basedataPointLongitude}" 
value="{$basedataArray[0]->basedataPointLatitude}"  -->
		</tr>
	    </table>
 ...
 value="{$z[1]}" -->
		...
		<table class="formView" align="center" width="100%">
			<tr><td colspan=4 class='tdhead'>矿种{$o[22]+1}</td></tr>
			<tr>
...
value="{$o[70]}" -->
	...
	<table class="formView" align="center" width='100%'>
		...
		<!--    value="{$basedataArray[0]->basedataDigreturnrate}" -->
		</tr>
	</table>
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_basedataDigreturnrate">
		<tr>
			<td id="t_basedataDigreturnrate_bef3" class="tdhead">{$basedataArray[0]->basedataJiqizhi-2}年实际值</td><td><input  name="basedataDigreturnrate_bef3"></td>
			<td id="t_basedataDigreturnrate_bef2" class="tdhead">{$basedataArray[0]->basedataJiqizhi-1}年实际值</td><td><input  name="basedataDigreturnrate_bef2"></td>
		</tr>
		<tr>
			<td id="t_basedataDigreturnrate_bef1" class="tdhead">{$basedataArray[0]->basedataJiqizhi}年实际值</td><td><input  name="basedataDigreturnrate_bef1"></td>
		</tr>
		<tr>
			<td id="t_basedataDigreturnrate_pre1"class="tdhead">{$basedataArray[0]->basedataJiqizhi+1}年规划值</td><td><input  name="basedataDigreturnrate_pre1"></td>
			<td id="t_basedataDigreturnrate_pre1real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+1}年实际值</td><td><input  name="basedataDigreturnrate_pre1real"></td>
		</tr>
		<tr>
			<td id="t_basedataDigreturnrate_pre2"class="tdhead">{$basedataArray[0]->basedataJiqizhi+2}年规划值</td><td><input  name="basedataDigreturnrate_pre2"></td>
			<td id="t_basedataDigreturnrate_pre2real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+2}年实际值</td><td><input  name="basedataDigreturnrate_pre2real"></td>
		</tr>
		<tr>
			<td id="t_basedataDigreturnrate_pre3" class="tdhead">{$basedataArray[0]->basedataJiqizhi+3}年规划值</td><td><input  name="basedataDigreturnrate_pre3"></td>
			<td id="t_basedataDigreturnrate_pre3real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+3}年实际值</td><td><input  name="basedataDigreturnrate_pre3real"></td>
		</tr>
		<!-- value="{$basedata35Array[0][0]}"
value="{$basedata35Array[0][1]}"
value="{$basedata35Array[0][2]}"
value="{$basedata35Array[0][3]}"
value="{$basedata35Array[0][4]}"
value="{$basedata35Array[0][5]}"
value="{$basedata35Array[0][6]}"
value="{$basedata35Array[0][7]}"
value="{$basedata35Array[0][8]}" -->
		<tr>
			<td id="t_basedataDigreturnrate_pre4" class="tdhead">{$basedataArray[0]->basedataJiqizhi+4}年规划值</td><td><input  name="basedataDigreturnrate_pre4"></td>
			<td id="t_basedataDigreturnrate_pre4real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+4}年实际值</td><td><input  name="basedataDigreturnrate_pre4real"></td>
		</tr>
		<tr>
			<td id="t_basedataDigreturnrate_pre5"class="tdhead">{$basedataArray[0]->basedataJiqizhi+5}年规划值</td><td><input  name="basedataDigreturnrate_pre5"></td>
			<td id="t_basedataDigreturnrate_pre5real"class="tdhead">{$basedataArray[0]->basedataJiqizhi+5}年实际值</td><td><input  name="basedataDigreturnrate_pre5real"></td>	  
			<!-- value="{$basedata35Array[0][9]}"
value="{$basedata35Array[0][10]}"
value="{$basedata35Array[0][11]}"
value="{$basedata35Array[0][12]}" -->
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
                <tr>
		...
		<!--  value="{$basedataArray[0]->basedataSepareturnrate}"
 value="{$basedataArray[0]->basedataMinertype}" -->
		</tr>
	</table>
<table align="center" style="display:none;" class="formView" id="bef3_pre5_basedataSepareturnrate">
		<tr>
			<td id="t_basedataSepareturnrate_bef3"class="tdhead">{$basedataArray[0]->basedataJiqizhi-2}年实际值</td><td><input name="basedataSepareturnrate_bef3"></td>
			<td id="t_basedataSepareturnrate_bef2" class="tdhead">{$basedataArray[0]->basedataJiqizhi-1}年实际值</td><td><input  name="basedataSepareturnrate_bef2"></td>
		</tr>
		<tr>
			<td id="t_basedataSepareturnrate_bef1" class="tdhead">{$basedataArray[0]->basedataJiqizhi}年实际值</td><td><input  name="basedataSepareturnrate_bef1"></td>
		</tr>
		<tr>
			<td id="t_basedataSepareturnrate_pre1" class="tdhead">{$basedataArray[0]->basedataJiqizhi+1}年规划值</td><td><input  name="basedataSepareturnrate_pre1"></td>
			<td id="t_basedataSepareturnrate_pre1real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+1}年实际值</td><td><input  name="basedataSepareturnrate_pre1real"></td>
		</tr>
		<tr>
			<td id="t_basedataSepareturnrate_pre2" class="tdhead">{$basedataArray[0]->basedataJiqizhi+2}年规划值</td><td><input  name="basedataSepareturnrate_pre2"></td>
			<td id="t_basedataSepareturnrate_pre2real"class="tdhead">{$basedataArray[0]->basedataJiqizhi+2}年实际值</td><td><input  name="basedataSepareturnrate_pre2real"></td>
		</tr>
		<tr>
			<td id="t_basedataSepareturnrate_pre3" class="tdhead">{$basedataArray[0]->basedataJiqizhi+3}年规划值</td><td><input  name="basedataSepareturnrate_pre3"></td>
			<td id="t_basedataSepareturnrate_pre3real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+3}年实际值</td><td><input  name="basedataSepareturnrate_pre3real"></td>
		</tr>
		<tr>
			<td id="t_basedataSepareturnrate_pre4" class="tdhead">{$basedataArray[0]->basedataJiqizhi+4}年规划值</td><td><input  name="basedataSepareturnrate_pre4"></td>
			<td id="t_basedataSepareturnrate_pre4real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+4}年实际值</td><td><input  name="basedataSepareturnrate_pre4real"></td>
		</tr>
		<tr>
			<td id="t_basedataSepareturnrate_pre5" class="tdhead">{$basedataArray[0]->basedataJiqizhi+5}年规划值</td><td><input  name="basedataSepareturnrate_pre5"></td>
			<td id="t_basedataSepareturnrate_pre5real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+5}年实际值</td><td><input  name="basedataSepareturnrate_pre5real"></td>	  
		</tr>
		<!-- value="{$basedata35Array[1][0]}" 
value="{$basedata35Array[1][1]}"
value="{$basedata35Array[1][2]}"
value="{$basedata35Array[1][3]}"
value="{$basedata35Array[1][4]}"
value="{$basedata35Array[1][5]}"
value="{$basedata35Array[1][6]}"
value="{$basedata35Array[1][7]}"
value="{$basedata35Array[1][8]}"
value="{$basedata35Array[1][9]}"
value="{$basedata35Array[1][10]}"
value="{$basedata35Array[1][11]}"
value="{$basedata35Array[1][12]}" -->
	</table>
	<table class="formView" align="center" width='100%'>
	<tr>
		...
		<td colspan=5>
			...
			{/if}
				...
				<!-- value="{$basedataArray[0]->basedataSepa}" -->
		</td>
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_basedataProduceScale">
		<tr>
			<td id="t_basedataProduceScale_bef3" class="tdhead">{$basedataArray[0]->basedataJiqizhi-2}年实际值</td><td><input  name="basedataProduceScale_bef3"></td>
			<td id="t_basedataProduceScale_bef2" class="tdhead">{$basedataArray[0]->basedataJiqizhi-1}年实际值</td><td><input  name="basedataProduceScale_bef2"></td>
		</tr>
		<tr>
			<td id="t_basedataProduceScale_bef1" class="tdhead">{$basedataArray[0]->basedataJiqizhi}年实际值</td><td><input  name="basedataProduceScale_bef1"></td>
		</tr>
		<tr>
			<td id="t_basedataProduceScale_pre1" class="tdhead">{$basedataArray[0]->basedataJiqizhi+1}年规划值</td><td><input  name="basedataProduceScale_pre1"></td>
			<td id="t_basedataProduceScale_pre1real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+1}年实际值</td><td><input  name="basedataProduceScale_pre1real"></td>
		</tr>
		<tr>
			<td id="t_basedataProduceScale_pre2" class="tdhead">{$basedataArray[0]->basedataJiqizhi+2}年规划值</td><td><input  name="basedataProduceScale_pre2"></td>
			<td id="t_basedataProduceScale_pre2real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+2}年实际值</td><td><input  name="basedataProduceScale_pre2real"></td>
		</tr>
		<tr>
			<td id="t_basedataProduceScale_pre3" class="tdhead">{$basedataArray[0]->basedataJiqizhi+3}年规划值</td><td><input  name="basedataProduceScale_pre3"></td>
			<td id="t_basedataProduceScale_pre3real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+3}年实际值</td><td><input  name="basedataProduceScale_pre3real"></td>
		</tr>
		<tr>
			<td id="t_basedataProduceScale_pre4" class="tdhead">{$basedataArray[0]->basedataJiqizhi+4}年规划值</td><td><input  name="basedataProduceScale_pre4"></td>
			<td id="t_basedataProduceScale_pre4real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+4}年实际值</td><td><input  name="basedataProduceScale_pre4real"></td>
		</tr>
		<tr>
			<td id="t_basedataProduceScale_pre5" class="tdhead">{$basedataArray[0]->basedataJiqizhi+5}年规划值</td><td><input  name="basedataProduceScale_pre5"></td>
			<td id="t_basedataProduceScale_pre5real" class="tdhead">{$basedataArray[0]->basedataJiqizhi+5}年实际值</td><td><input  name="basedataProduceScale_pre5real"></td>	  
		</tr>
		<!-- value="{$basedataArray[0]->basedataProduceScale}"
value="{$basedataArray[0]->basedataOrgan}"
value="{$basedata35Array[2][0]}"
value="{$basedata35Array[2][1]}"
value="{$basedata35Array[2][2]}"
value="{$basedata35Array[2][3]}"
value="{$basedata35Array[2][4]}"
value="{$basedata35Array[2][5]}"
value="{$basedata35Array[2][6]}"
value="{$basedata35Array[2][7]}"
value="{$basedata35Array[2][8]}"
value="{$basedata35Array[2][9]}"
value="{$basedata35Array[2][10]}"
value="{$basedata35Array[2][11]}"
value="{$basedata35Array[2][12]}" -->
	</table>
	...
	<table class="formView" align="center"  width="100%">
		<tr>
			...
			<!-- value="{$basedataArray[0]->basedataYuanHua}"
value="{$basedataArray[0]->basedataWeiHua}" -->
		</tr>
	</table>
