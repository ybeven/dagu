...
{include file="../webroot/js/jqueryui.js"}
</script>
...
{$__script}
{if $notice}<script type="text/javascript">alert("{$notice}");</script>{/if}
</head>
...
<div id='container'>
	<div id='header'>
		...
		<div class="name1">|&nbsp;&nbsp;<a href="/system/logout">退出</a></div>
                ...
                <div class="name2">{$curUser.name}</div>
        	...
        	<div id='box'>
        		<div id='accordion'>
					<div>
						<h3><a>原始成绩导入</a></h3>
						<div>	
							{acquire action='申报信息管理' visitor=$curUser}
					...
					<!-- <div>
						<h3><a>规划项目管理</a></h3>
						<div>	
							{acquire action='规划信息管理' visitor=$curUser}
					...
					<div>
						<h3><a>专家信息管理</a></h3>
						<div>
							{acquire action='专家信息管理' visitor=$curUser}
					...
					<div>
						<h3><a>成绩查询</a></h3>
						<div>
							{acquire action='项目信息查询' visitor=$curUser}
					...
					<!-- {acquire action='地图管理' visitor=$curUser} -->
					<!-- <div>
						<h3><a>Gis地图管理</a></h3>
						<div>
					...
					<div>
						<h3><a>数据统计管理</a></h3>
						<div>
							{acquire action='数据统计管理' visitor=$curUser}
