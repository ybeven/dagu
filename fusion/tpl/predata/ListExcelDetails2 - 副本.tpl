...
<form name="form" action="/predata/SavePreData/{$fileId}" method="post">
	<div id="tabs">
	...
	<table class="formView" align="center" id="basic_info">
		...
		<tr>
			...
			<td width="30%">
				<input cols="60" rows="1"  name="enterpriseName" value="{$declaredata[2]}">
			</td>
			<td width="20%" class='tdhead'>开采方式</td>
			<td colspan=3>
				<input cols="60" rows="3" width="90%" name="fangshi" value="{$declaredata[10]}">
			</td>
		</tr>
		<tr>
        ...
        <script type="text/javascript">
                $('#shi').val("{/literal}{$declaredata[30]}{literal}");
                changexz();
                $('#xian').val("{/literal}{$declaredata[31]}{literal}");
                </script>
                {/literal}
		<tr>
			<td width="20%" class='tdhead'>乡镇行政区划</td><td width="30%"><input value="{$declaredata[5]}" width="90%" name="diliweizhi"></td>
		...
		<!-- 改动 -->
		<tr>
			<td width="20%" class='tdhead'>矿种类别</td><td width="30%"><input value="{$declaredata[9]}" width="90%" name="orenametype"></td>
			<td width="20%" class='tdhead'>开采矿种</td><td width="30%"><input value="{$declaredata[32]}" width="90%" name="orename"></td>
		</tr>
		...
		<!-- 改动 -->
<!-- 		<tr>
			<td width="20%" class='tdhead'>开采方式</td><td colspan=3><textarea cols="60" rows="3" width="90%" name="fangshi">{$declaredata[10]}</textarea></td>
		</tr> -->
		<tr>                     
