				...
				<tr>
					...
					<td>
					   	<select   name="subpriority"  id="subpriority" onfocus="Popup.showModal('subpriority_div');return false;" >
							<option value={$subpriority} id="subpriority_text">{$subpriority|truncate:9:""}</option>
						</select>	
					...
					<td>					
				    	<select   name="positionx"  id="positionx" onfocus="Popup.showModal('positionx_div');return false;" >
							<option value={$positionx} id="positionx_text">{$positionx|truncate:10:""}</option>
						</select>	
...
<caption>{$city}{$indexname}统计</caption>
{if $disapearTable==1}
 <tr>
