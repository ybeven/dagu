<?php /* Smarty version 2.6.26, created on 2014-11-12 10:46:58
         compiled from predata/AddPreData7.tpl */ ?>
...
'; ?>
	...
	// alert(x);
	document.getElementById("form").action="/predata/UploadeExcelData7/"+x;
...
<form name="form" id="form" action="/predata/UploadeExcelData7" method="post" enctype="multipart/form-data">
