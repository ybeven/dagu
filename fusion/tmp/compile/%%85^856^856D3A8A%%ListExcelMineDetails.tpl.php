<?php /* Smarty version 2.6.26, created on 2014-11-10 16:39:53
         compiled from minedata/ListExcelMineDetails.tpl */ ?>
...
'; ?>
	...
	<?php $_from = $this->_tpl_vars['ores']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['o']):
?>
	$("#button_orehuishou<?php echo $this->_tpl_vars['o']['_o22']; ?>
").click(function()<?php echo '{'; ?>
$('#bef3_pre5_orehuishou<?php echo $this->_tpl_vars['o']['_o22']; ?>
').toggle();<?php echo '})'; ?>
;
	$("#button_oreGoback<?php echo $this->_tpl_vars['o']['_o22']; ?>
").click(function()<?php echo '{'; ?>
$('#bef3_pre5_oreGoback<?php echo $this->_tpl_vars['o']['_o22']; ?>
').toggle();<?php echo '})'; ?>
;
	$("#button_basedataorelevelh<?php echo $this->_tpl_vars['o']['_o22']; ?>
").click(function()<?php echo '{'; ?>
$('#oreLevelhs<?php echo $this->_tpl_vars['o']['_o22']; ?>
').toggle();<?php echo '}'; ?>
);
	$("#button_basedataorelevela<?php echo $this->_tpl_vars['o']['_o22']; ?>
").click(function()<?php echo '{'; ?>
$('#oreLevelas<?php echo $this->_tpl_vars['o']['_o22']; ?>
').toggle();<?php echo '}'; ?>
);
...
<?php echo $this->_tpl_vars['mineid']; ?>
<?php echo ',data:$("#testform").serializeArray(),success:function(msg){alert("保存成功");}});
...
<div id="tabs">
   <ul>
	...
	<table class="formView" align="center" id="basedata" width='100%'>
		...
		<tr>
			<td class="tdhead">规划报告名称</td><td ><textarea cols="30" rows="2" name="basedataBgname" ><?php echo $this->_tpl_vars['declaredata'][1]; ?>
</textarea></td>
			<td class="tdhead">绿色矿山级别</td><td ><select  name="basedataGreenlvl">
					<option value="<?php echo $this->_tpl_vars['declaredata'][9999]; ?>
"><?php echo $this->_tpl_vars['declaredata'][9999]; ?>
</option>
		...
		<tr>
			<td class="tdhead">规划期限</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][2]; ?>
" name="basedataLimit"></td>
			<td class="tdhead">规划基期(年份)</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][3]; ?>
"  id="basedataJiqizhi" name="basedataJiqizhi" onchange="changeyears()"></td>
		</tr>
		<tr>
			<td class="tdhead">组织单位</td><td><input  value="<?php echo $this->_tpl_vars['declaredata'][4]; ?>
"  name="basedataOrgan"></td>
			<td class="tdhead">编制单位</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][5]; ?>
" name="basedataEstablish"></td>
		</tr>
		<tr>
			<td class="tdhead">报告出具日期</td><td><input class="datepicker" value="<?php echo $this->_tpl_vars['declaredata'][7]; ?>
" name="basedataBgdate"></td>
			<td class="tdhead">矿山名称</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][6]; ?>
" name="basedataMinename"></td>
		</tr>
		<tr>
			<td class="tdhead">矿山成立时间</td><td><input  class="datepicker" value="<?php echo $this->_tpl_vars['declaredata'][8]; ?>
" name="basedataBuildtime"></td>
			<td class="tdhead">企业名称</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][9]; ?>
" name="basedataCompanyname"></td>
		</tr>
		<tr>
		<td class="tdhead">企业性质</td><td><select  name="basedataEnterpriseproperty">
					<option value="<?php echo $this->_tpl_vars['declaredata'][10]; ?>
"><?php echo $this->_tpl_vars['declaredata'][10]; ?>
</option>
		...
		<td class="tdhead">所属企业名称</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][11]; ?>
" name="basedataOwedname"></td>
		...
		<tr>
			<td class="tdhead">省（自治区、直辖市）</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][12]; ?>
" name="basedataDivisionsSheng"></td>
			<td class="tdhead">市</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][13]; ?>
" name="basedataDivisionsShi"></td>
		</tr>
		<tr>
			<td class="tdhead">县</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][14]; ?>
" name="basedataDivisionsXian"></td>
			<td class="tdhead">镇</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][15]; ?>
" name="basedataDivisionsZhen"></td>
		</tr>
		<tr>
			<td class="tdhead">行政区代码</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][16]; ?>
" name="basedataDivisions"></td>
			<td class="tdhead">矿山面积(平方千米)</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][19]; ?>
" name="basedataArea"></td>
		...
		<!-- <tr>
		<td class="tdhead">经度</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][17]; ?>
" name="basedataAreaLongitude"></td>
		<td class="tdhead">纬度</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][18]; ?>
" name="basedataAreaLatitude"></td>
		</tr> -->
		<tr>
		
		</tr>
		<tr>
			<td class="tdtitle" colspan=4 algin='center'>矿业权类型 <input value="<?php echo $this->_tpl_vars['declaredata'][20]; ?>
" name="basedataAuthority"></td>
		</tr>
		<tr>
		<td class="tdhead">采矿权</td><td><textarea cols="60" rows="3"  name="basedataAuthDig"><?php echo $this->_tpl_vars['declaredata'][21]; ?>
</textarea></td>
		<td class="tdhead">探矿权</td><td><textarea cols="60" rows="3"  name="basedataAuthFind"><?php echo $this->_tpl_vars['declaredata'][22]; ?>
</textarea></td>
		</tr>
                <tr>
		<td class="tdhead">划定矿区范围(平方千米)</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][23]; ?>
" name="basedataAuthArea"></td>
		<td class="tdhead">采矿标高(米)</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][24]; ?>
" name="basedataAuthHeight"></td>
		</tr>
                <tr>
		<td class="tdhead">矿业权证号</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][25]; ?>
" name="basedataAuthNum"></td>
		<td class="tdhead">单位地址</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][26]; ?>
" name="basedataAuthAddress"></td>
		</tr>
		<tr>
		<td class="tdhead">有效期限</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][27]; ?>
" name="basedataAuthDeadline"></td>
		<td class="tdhead">发证时间</td><td><input   class="datepicker" value="<?php echo $this->_tpl_vars['declaredata'][28]; ?>
" name="basedataAuthGetime"></td>
		</tr>
		<tr>
		<td class="tdhead">发证机关</td><td colspan=3><textarea cols="60" rows="3"  name="basedataAuthOrgan"><?php echo $this->_tpl_vars['declaredata'][29]; ?>
</textarea></td> 
		</tr>
		<tr>
		...
		<tr>
		<td class="tdhead">经度</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][30]; ?>
" name="basedataPointLongitude"></td>
		<td class="tdhead">纬度</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][31]; ?>
" name="basedataPointLatitude"></td>
		</tr>
		<?php $_from = $this->_tpl_vars['jingWei']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['o']):
?>
		<tr>
			<td class="tdhead">经度</td><td><input value="<?php echo $this->_tpl_vars['o'][0]; ?>
" name="basedataZuobiaoJing[]"></td>
			<td class="tdhead">纬度</td><td><input value="<?php echo $this->_tpl_vars['o'][1]; ?>
" name="basedataZuobiaoWei[]"></td>
		</tr>
		<?php endforeach; endif; unset($_from); ?>
		<tr>
		...
		<tr>
			<td>
				<table class="formView" align="center" width="100%">
					<tr><td colspan=4 class='tdtitle'>矿种<?php echo $this->_tpl_vars['o']['_o22']+1; ?>
</td></tr>
					<tr>
...
"><?php echo $this->_tpl_vars['o'][1]; ?>
					...
					<tr><td colspan=4 class='tdtitle'>储量级别</td></tr>
						...
						<td width="30%"><input type="text" name="oreLevelh[]" value="<?php echo $this->_tpl_vars['o'][39]; ?>
" width="90%"/><input type="button" id="button_basedataorelevelh<?php echo $this->_tpl_vars['o']['_o22']; ?>
" value="详情"/></td>
						<td class="tdhead">可采储量</td>
						<td width="30%"><input type="text" name="oreLevela[]" value="<?php echo $this->_tpl_vars['o'][40]; ?>
" width="90%"/><input type="button" id="button_basedataorelevela<?php echo $this->_tpl_vars['o']['_o22']; ?>
" value="详情"/></td>
						<tr><td colspan=4 style="border:none">
						<table align="center" style="display:none;" class="formView" id="oreLevelhs<?php echo $this->_tpl_vars['o']['_o22']; ?>
">
							<tr>
...
" name="oreLevelh334[]"></td>	  
						...
						<tr><td colspan=4 style="border:none"><table align="center" style="display:none;" class="formView" id="oreLevelas<?php echo $this->_tpl_vars['o']['_o22']; ?>
">
							<tr>
...
" name="oreLevela334[]"></td>	  
	...
	<table class="formView" align="center"  width="100%">
	<tr>
			<td class="tdhead">原矿化学组分</td><td colspan=3><textarea cols="60" rows="3" name="basedataYuanHua"><?php echo $this->_tpl_vars['declaredata'][10000]; ?>
</textarea></td>
			<td class="tdhead">尾矿化学组分</td><td colspan=3><textarea cols="60" rows="3" name="basedataWeiHua"><?php echo $this->_tpl_vars['declaredata'][10001]; ?>
</textarea></td>
	</tr>
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
			<td class="tdtitle" width="20%">矿山资源储量(吨)</td><td class="tdtitle" width="30%"><input value="<?php echo $this->_tpl_vars['declaredata'][35]; ?>
" name="basedataResourcesTotal"></td>
			<td class="tdtitle" width="20%">储量规模</td>
			<td class="tdtitle">
				<select name="basedataMinescale">
					<option value="<?php echo $this->_tpl_vars['declaredata'][36]; ?>
"><?php echo $this->_tpl_vars['declaredata'][36]; ?>
</option>
		...
		<td class="tdhead">矿山开采方式</td><td><select  name="basedataDigtype">
					<option value="<?php echo $this->_tpl_vars['declaredata'][39]; ?>
"><?php echo $this->_tpl_vars['declaredata'][39]; ?>
</option>
		...
		<td class="tdhead">矿山开采回采率(%)</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][40]; ?>
" name="basedataDigreturnrate"><input type="button" id="button_basedataDigreturnrate" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_basedataDigreturnrate">
		<tr>
			<td id="t_basedataDigreturnrate_bef3" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][0]; ?>
" name="basedataDigreturnrate_bef3"></td>
			<td id="t_basedataDigreturnrate_bef2" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][1]; ?>
" name="basedataDigreturnrate_bef2"></td>
		</tr>
		<tr>
			<td id="t_basedataDigreturnrate_bef1" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][2]; ?>
" name="basedataDigreturnrate_bef1"></td>
		</tr>
		<tr>
			<td id="t_basedataDigreturnrate_pre1"class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][3]; ?>
" name="basedataDigreturnrate_pre1"></td>
			<td id="t_basedataDigreturnrate_pre1real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][4]; ?>
" name="basedataDigreturnrate_pre1real"></td>
		</tr>
		<tr>
			<td id="t_basedataDigreturnrate_pre2"class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][5]; ?>
" name="basedataDigreturnrate_pre2"></td>
			<td id="t_basedataDigreturnrate_pre2real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][6]; ?>
" name="basedataDigreturnrate_pre2real"></td>
		</tr>
		<tr>
			<td id="t_basedataDigreturnrate_pre3" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][7]; ?>
" name="basedataDigreturnrate_pre3"></td>
			<td id="t_basedataDigreturnrate_pre3real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][8]; ?>
" name="basedataDigreturnrate_pre3real"></td>
		</tr>
		<tr>
			<td id="t_basedataDigreturnrate_pre4" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][9]; ?>
" name="basedataDigreturnrate_pre4"></td>
			<td id="t_basedataDigreturnrate_pre4real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][10]; ?>
" name="basedataDigreturnrate_pre4real"></td>
		</tr>
		<tr>
			<td id="t_basedataDigreturnrate_pre5"class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][11]; ?>
" name="basedataDigreturnrate_pre5"></td>
			<td id="t_basedataDigreturnrate_pre5real"class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][12]; ?>
" name="basedataDigreturnrate_pre5real"></td>	  
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
                <tr>
		<td class="tdhead">矿山选矿回收率(%)</td><td width="30%"><input   value="<?php echo $this->_tpl_vars['declaredata'][41]; ?>
" name="basedataSepareturnrate"><input type="button" id="button_basedataSepareturnrate" value="详情"/></td>	
		<td class="tdhead">矿山矿床类型</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][42]; ?>
" name="basedataMinertype"></td>
		</tr>
	</table>
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_basedataSepareturnrate">
		<tr>
			<td id="t_basedataSepareturnrate_bef3"class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][0]; ?>
" name="basedataSepareturnrate_bef3"></td>
			<td id="t_basedataSepareturnrate_bef2" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][1]; ?>
" name="basedataSepareturnrate_bef2"></td>
		</tr>
		<tr>
			<td id="t_basedataSepareturnrate_bef1" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][2]; ?>
" name="basedataSepareturnrate_bef1"></td>
		</tr>
		<tr>
			<td id="t_basedataSepareturnrate_pre1" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][3]; ?>
" name="basedataSepareturnrate_pre1"></td>
			<td id="t_basedataSepareturnrate_pre1real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][4]; ?>
" name="basedataSepareturnrate_pre1real"></td>
		</tr>
		<tr>
			<td id="t_basedataSepareturnrate_pre2" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][5]; ?>
" name="basedataSepareturnrate_pre2"></td>
			<td id="t_basedataSepareturnrate_pre2real"class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][6]; ?>
" name="basedataSepareturnrate_pre2real"></td>
		</tr>
		<tr>
			<td id="t_basedataSepareturnrate_pre3" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][7]; ?>
" name="basedataSepareturnrate_pre3"></td>
			<td id="t_basedataSepareturnrate_pre3real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][8]; ?>
" name="basedataSepareturnrate_pre3real"></td>
		</tr>
		<tr>
			<td id="t_basedataSepareturnrate_pre4" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][9]; ?>
" name="basedataSepareturnrate_pre4"></td>
			<td id="t_basedataSepareturnrate_pre4real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][10]; ?>
" name="basedataSepareturnrate_pre4real"></td>
		</tr>
		<tr>
			<td id="t_basedataSepareturnrate_pre5" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][11]; ?>
" name="basedataSepareturnrate_pre5"></td>
			<td id="t_basedataSepareturnrate_pre5real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_kaicaihuicailv'][12]; ?>
	...
	<table class="formView" align="center" width='100%'>
		...
		<td colspan=3>
			...
			<?php endif; ?>
				...
				<input type="text" value="<?php echo $this->_tpl_vars['Mining_methodsdata'][5]; ?>
" name="basedataSepa" >
		</td>
		</tr>
		<tr>
			<td class="tdtitle" colspan=4>实际生产规模<input value="<?php echo $this->_tpl_vars['declaredata'][44]; ?>
" name="basedataProduceScale"><input type="button" id="button_basedataProduceScale" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_basedataProduceScale">
		<tr>
			<td id="t_basedataProduceScale_bef3" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][0]; ?>
" name="basedataProduceScale_bef3"></td>
			<td id="t_basedataProduceScale_bef2" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][1]; ?>
" name="basedataProduceScale_bef2"></td>
		</tr>
		<tr>
			<td id="t_basedataProduceScale_bef1" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][2]; ?>
" name="basedataProduceScale_bef1"></td>
		</tr>
		<tr>
			<td id="t_basedataProduceScale_pre1" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][3]; ?>
" name="basedataProduceScale_pre1"></td>
			<td id="t_basedataProduceScale_pre1real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][4]; ?>
" name="basedataProduceScale_pre1real"></td>
		</tr>
		<tr>
			<td id="t_basedataProduceScale_pre2" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][5]; ?>
" name="basedataProduceScale_pre2"></td>
			<td id="t_basedataProduceScale_pre2real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][6]; ?>
" name="basedataProduceScale_pre2real"></td>
		</tr>
		<tr>
			<td id="t_basedataProduceScale_pre3" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][7]; ?>
" name="basedataProduceScale_pre3"></td>
			<td id="t_basedataProduceScale_pre3real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][8]; ?>
" name="basedataProduceScale_pre3real"></td>
		</tr>
		<tr>
			<td id="t_basedataProduceScale_pre4" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][9]; ?>
" name="basedataProduceScale_pre4"></td>
			<td id="t_basedataProduceScale_pre4real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][10]; ?>
" name="basedataProduceScale_pre4real"></td>
		</tr>
		<tr>
			<td id="t_basedataProduceScale_pre5" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][11]; ?>
" name="basedataProduceScale_pre5"></td>
			<td id="t_basedataProduceScale_pre5real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_shijishengchanguimo'][12]; ?>
" name="basedataProduceScale_pre5real"></td>	  
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
			<td class="tdhead">开采规模</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][45]; ?>
" name="basedataProduceDig"><select name="basedataProduceDigUnit">
					<option value="<?php echo $this->_tpl_vars['declaredata'][46]; ?>
"><?php echo $this->_tpl_vars['declaredata'][46]; ?>
</option>
					<option value="吨/年">吨/年</option>
					<option value="吨/天">吨/天</option>
					</select></td>
			<td class="tdhead">选矿厂规模</td><td><input value="<?php echo $this->_tpl_vars['declaredata'][47]; ?>
" name="basedataProduceFactory"><select name="basedataProduceFactoryUnit">
					<option value="<?php echo $this->_tpl_vars['declaredata'][48]; ?>
"><?php echo $this->_tpl_vars['declaredata'][48]; ?>
</option>
					<option value="吨/年">吨/年</option>
					<option value="吨/天">吨/天</option>
					</select></td>
		...
		<tr>
		<td class="tdhead">金属类</td><td colspan=3><textarea cols="60" rows="3"  name="basedataPlanMetal"><?php echo $this->_tpl_vars['declaredata'][49]; ?>
</textarea></td>
		</tr>
		<tr>
		<td class="tdhead">能源类</td><td colspan=3><textarea cols="60" rows="3"  name="basedataPlanEnergy"><?php echo $this->_tpl_vars['declaredata'][50]; ?>
</textarea></td>
		</tr>
		<tr>
		<td class="tdhead">非金属类</td><td colspan=3><textarea cols="60" rows="3"  name="basedataPlanNot"><?php echo $this->_tpl_vars['declaredata'][51]; ?>
</textarea></td>
		</tr>
		<tr>
		...
		<tr>
		<td class="tdhead">矿山企业总产值(万元)</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][52]; ?>
" name="basedataValue"><input type="button" id="button_basedataValue" value="详情"/></td>
		<td class="tdhead">矿山企业利税(万元)</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][53]; ?>
" name="basedataFee"><input type="button" id="button_basedataFee" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_basedataValue">
		<tr>
			<td id="t_basedataValue_bef3" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][0]; ?>
" name="basedataValue_bef3"></td>
			<td id="t_basedataValue_bef2" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][1]; ?>
" name="basedataValue_bef2"></td>
		</tr>
		<tr>
			<td id="t_basedataValue_bef1" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][2]; ?>
" name="basedataValue_bef1"></td>
		</tr>
		<tr>
			<td id="t_basedataValue_pre1" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][3]; ?>
" name="basedataValue_pre1"></td>
			<td id="t_basedataValue_pre1real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][4]; ?>
" name="basedataValue_pre1real"></td>
		</tr>
		<tr>
			<td id="t_basedataValue_pre2" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][5]; ?>
" name="basedataValue_pre2"></td>
			<td id="t_basedataValue_pre2real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][6]; ?>
" name="basedataValue_pre2real"></td>
		</tr>
		<tr>
			<td id="t_basedataValue_pre3" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][7]; ?>
" name="basedataValue_pre3"></td>
			<td id="t_basedataValue_pre3real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][8]; ?>
" name="basedataValue_pre3real"></td>
		</tr>
		<tr>
			<td id="t_basedataValue_pre4" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][9]; ?>
" name="basedataValue_pre4"></td>
			<td id="t_basedataValue_pre4real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][10]; ?>
" name="basedataValue_pre4real"></td>
		</tr>
		<tr>
			<td id="t_basedataValue_pre5" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][11]; ?>
" name="basedataValue_pre5"></td>
			<td id="t_basedataValue_pre5real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zongchanzhi'][12]; ?>
" name="basedataValue_pre5real"></td>	  
		</tr>
	</table>
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_basedataFee">
		<tr>
			<td id="t_basedataFee_bef3" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][0]; ?>
" name="basedataFee_bef3"></td>
			<td id="t_basedataFee_bef2" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][1]; ?>
" name="basedataFee_bef2"></td>
		</tr>
		<tr>
			<td id="t_basedataFee_bef1" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][2]; ?>
" name="basedataFee_bef1"></td>
		</tr>
		<tr>
			<td id="t_basedataFee_pre1" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][3]; ?>
" name="basedataFee_pre1"></td>
			<td id="t_basedataFee_pre1real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][4]; ?>
" name="basedataFee_pre1real"></td>
		</tr>
		<tr>
			<td id="t_basedataFee_pre2" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][5]; ?>
" name="basedataFee_pre2"></td>
			<td id="t_basedataFee_pre2real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][6]; ?>
" name="basedataFee_pre2real"></td>
		</tr>
		<tr>
			<td id="t_basedataFee_pre3" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][7]; ?>
" name="basedataFee_pre3"></td>
			<td id="t_basedataFee_pre3real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][8]; ?>
" name="basedataFee_pre3real"></td>
		</tr>
		<tr>
			<td id="t_basedataFee_pre4" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][9]; ?>
" name="basedataFee_pre4"></td>
			<td id="t_basedataFee_pre4real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][10]; ?>
" name="basedataFee_pre4real"></td>
		</tr>
		<tr>
			<td id="t_basedataFee_pre5" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][11]; ?>
" name="basedataFee_pre5"></td>
			<td id="t_basedataFee_pre5real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_zonglishui'][12]; ?>
" name="basedataFee_pre5real"></td>	  
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
		<td class="tdhead">矿山企业利润(万元)</td><td width="30%"><input   value="<?php echo $this->_tpl_vars['declaredata'][54]; ?>
" name="basedataProfit"><input type="button" id="button_basedataProfit" value="详情"/></td>
		<td class="tdhead">矿山企业人数(人)</td><td><input   value="<?php echo $this->_tpl_vars['declaredata'][55]; ?>
" name="basedataWorker"></td>
		</tr>
	</table>
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_basedataProfit">
		<tr>
			<td id="t_basedataProfit_bef3" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][0]; ?>
" name="basedataProfit_bef3"></td>
			<td id="t_basedataProfit_bef2" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][1]; ?>
" name="basedataProfit_bef2"></td>
		</tr>
		<tr>
			<td id="t_basedataProfit_bef1"class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][2]; ?>
" name="basedataProfit_bef1"></td>
		</tr>
		<tr>
			<td id="t_basedataProfit_pre1" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][3]; ?>
" name="basedataProfit_pre1"></td>
			<td id="t_basedataProfit_pre1real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][4]; ?>
" name="basedataProfit_pre1real"></td>
		</tr>
		<tr>
			<td id="t_basedataProfit_pre2" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][5]; ?>
" name="basedataProfit_pre2"></td>
			<td id="t_basedataProfit_pre2real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][6]; ?>
" name="basedataProfit_pre2real"></td>
		</tr>
		<tr>
			<td id="t_basedataProfit_pre3" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][7]; ?>
" name="basedataProfit_pre3"></td>
			<td id="t_basedataProfit_pre3real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][8]; ?>
" name="basedataProfit_pre3real"></td>
		</tr>
		<tr>
			<td id="t_basedataProfit_pre4" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][9]; ?>
" name="basedataProfit_pre4"></td>
			<td id="t_basedataProfit_pre4real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][10]; ?>
" name="basedataProfit_pre4real"></td>
		</tr>
		<tr>
			<td id="t_basedataProfit_pre5" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][11]; ?>
" name="basedataProfit_pre5"></td>
			<td id="t_basedataProfit_pre5real" class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['data_35_qiyelirun'][12]; ?>
" name="basedataProfit_pre5real"></td>	  
	...
	<table class="formView" align="center" width='100%'>
		...
		<tr>
			<td class="tdhead">描述</td><td colspan=3><textarea cols="60" rows="3"  name="basedataReward"><?php echo $this->_tpl_vars['declaredata'][56]; ?>
</textarea></td>
		</tr>
		<!-- <tr>
	...
	<div id="tabs-2"><!--依法办矿-->
		<table id="legal" class="listView" width="100%">
			...
			<tr>
				<td>《营业执照》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][2][1]; ?>
" name="legal6Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][2][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][2][3]; ?>
" id ="legal6Deadline" class="datepicker" name="legal6Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][2][4]; ?>
" id="legal6Deadlinend" name="legal6Deadlinend" class="datepicker" onchange="loadchecktime(this)"></td>
				<td><textarea cols="30" rows="2"  id ="legal6Comm" name="legal6Comm"><?php echo $this->_tpl_vars['credentialsData'][2][5]; ?>
</textarea></td>
			</tr>
			<tr>
				<td>《采矿许可证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][3][1]; ?>
" name="legal1Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][3][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][3][3]; ?>
" class="datepicker" id="legal1Deadline" name="legal1Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][3][4]; ?>
" class="datepicker" id="legal1Deadlinend" name="legal1Deadlinend" onchange="loadchecktime(this)"></td>
				<td><textarea cols="30" rows="2"  id="legal1Comm" name="legal1Comm"><?php echo $this->_tpl_vars['credentialsData'][3][5]; ?>
</textarea></td>
			</tr>
			<tr>
				<td>《矿山生产许可证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][4][1]; ?>
" name="legal2Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][4][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][4][3]; ?>
" class="datepicker" id="legal2Deadline" name="legal2Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][4][4]; ?>
" class="datepicker" id="legal2Deadlinend" name="legal2Deadlinend" onchange="loadchecktime(this)"></td>
				<td><textarea cols="30" rows="2"  id="legal2Comm" name="legal2Comm"><?php echo $this->_tpl_vars['credentialsData'][4][5]; ?>
</textarea></td>
			</tr>
			<tr>
				<td>《矿山安全生产许可证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][5][1]; ?>
" name="legal3Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][5][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][5][3]; ?>
" class="datepicker" id="legal3Deadline" name="legal3Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][5][4]; ?>
" class="datepicker" id="legal3Deadlinend" name="legal3Deadlinend" onchange="loadchecktime(this)"></td>
				<td><textarea cols="30" rows="2"  id="legal3Comm" name="legal3Comm"><?php echo $this->_tpl_vars['credentialsData'][5][5]; ?>
</textarea></td>
			</tr>
			<tr>
				<td>《矿长安全生产许可证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][6][1]; ?>
" name="legal4Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][6][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][6][3]; ?>
" class="datepicker" id="legal4Deadline" name="legal4Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][6][4]; ?>
" class="datepicker" id = "legal4Deadlinend" name="legal4Deadlinend" onchange="loadchecktime(this)" ></td>
				<td><textarea cols="30" rows="2"  id="legal4Comm" name="legal4Comm"><?php echo $this->_tpl_vars['credentialsData'][6][5]; ?>
</textarea></td>
			</tr>		
			<tr>
				<td>《矿长资格证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][7][1]; ?>
" name="legal5Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][7][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][7][3]; ?>
" class="datepicker" id="legal5Deadline" name="legal5Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][7][4]; ?>
" class="datepicker" id = "legal5Deadlinend" name="legal5Deadlinend" onchange="loadchecktime(this)"></td>
				<td><textarea cols="30" rows="2"  id="legal5Comm" name="legal5Comm"><?php echo $this->_tpl_vars['credentialsData'][7][5]; ?>
</textarea></td>
			</tr>				
			<tr>
				<td>《民用爆炸物品使用许可证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][8][1]; ?>
" name="legal7Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][8][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][8][3]; ?>
" class="datepicker" id="legal7Deadline" name="legal7Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][8][4]; ?>
" class="datepicker" id = "legal7Deadlinend" name="legal7Deadlinend" onchange="loadchecktime(this)" ></td>
				<td><textarea cols="30" rows="2"  id="legal7Comm" name="legal7Comm"><?php echo $this->_tpl_vars['credentialsData'][8][5]; ?>
</textarea></td>
			</tr>		
			<tr>
				<td>《爆破物品存储证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][9][1]; ?>
" name="legal8Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][9][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][9][3]; ?>
" class="datepicker" id="legal8Deadline" name="legal8Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][9][4]; ?>
" class="datepicker" id ="legal8Deadlinend" name="legal8Deadlinend" onchange="loadchecktime(this)"></td>
				<td><textarea cols="30" rows="2"  id="legal8Comm" name="legal8Comm"><?php echo $this->_tpl_vars['credentialsData'][9][5]; ?>
</textarea></td>
			</tr>
			<tr>
				<td>《爆破人员安全资格证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][10][1]; ?>
" name="legal10Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][10][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][10][3]; ?>
" class="datepicker" id="legal10Deadline" name="legal10Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][10][4]; ?>
" class="datepicker" id="legal10Deadlinend" name="legal10Deadlinend" onchange="loadchecktime(this)" ></td>
				<td><textarea cols="30" rows="2"  id="legal10Comm" name="legal10Comm"><?php echo $this->_tpl_vars['credentialsData'][10][5]; ?>
</textarea></td>
			</tr>
			<tr>
				<td>《排污许可证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][11][1]; ?>
" name="legal11Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][11][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][11][3]; ?>
" class="datepicker" id="legal11Deadline" name="legal11Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][11][4]; ?>
" class="datepicker" id="legal11Deadlinend" name="legal11Deadlinend" onchange="loadchecktime(this)"></td>
				<td><textarea cols="30" rows="2"  id="legal11Comm" name="legal11Comm"><?php echo $this->_tpl_vars['credentialsData'][11][5]; ?>
</textarea></td>
			</tr>
			<tr>
				<td>《取水许可证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][12][1]; ?>
" name="legal12Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][12][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][12][3]; ?>
" class="datepicker" id="legal12Deadline" name="legal12Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][12][4]; ?>
" class="datepicker" id="legal12Deadlinend" name="legal12Deadlinend" onchange="loadchecktime(this)"></td>
				<td><textarea cols="30" rows="2"  id="legal12Comm" name="legal12Comm"><?php echo $this->_tpl_vars['credentialsData'][12][5]; ?>
</textarea></td>
			</tr>
			<tr>
				<td>《税务登记证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][13][1]; ?>
" name="legal13Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][13][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][13][3]; ?>
" class="datepicker" id ="legal13Deadline" name="legal13Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][13][4]; ?>
" class="datepicker" id="legal13Deadlinend" name="legal13Deadlinend" onchange="loadchecktime(this)"></td>
				<td><textarea cols="30" rows="2"  id="legal13Comm" name="legal13Comm"><?php echo $this->_tpl_vars['credentialsData'][13][5]; ?>
</textarea></td>
			</tr>
			<tr>
				<td>《组织机构代码证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][14][1]; ?>
" name="legal14Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][14][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][14][3]; ?>
" class="datepicker"  id = "legal14Deadline" name="legal14Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][14][4]; ?>
" class="datepicker" id="legal14Deadlinend" name="legal14Deadlinend" onchange="loadchecktime(this)"></td>
				<td><textarea cols="30" rows="2"  id="legal14Comm" name="legal14Comm"><?php echo $this->_tpl_vars['credentialsData'][14][5]; ?>
</textarea></td>
			</tr>
			<tr>
				<td>《土地使用权证》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][15][1]; ?>
" name="legal15Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][15][2] == '是'): ?>
				<td>		
				...
				<?php endif; ?>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][15][3]; ?>
" class="datepicker" id="legal15Deadline" name="legal15Deadline" ></td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][15][4]; ?>
" class="datepicker" id="legal15Deadlinend" name="legal15Deadlinend" onchange="loadchecktime(this)"></td>
				<td><textarea cols="30" rows="2"  id="legal15Comm" name="legal15Comm"><?php echo $this->_tpl_vars['credentialsData'][15][5]; ?>
</textarea></td>
			</tr>
			<tr>
				<td>《黄金生产批准书》</td>
				<td><input type="text"  value="<?php echo $this->_tpl_vars['credentialsData'][16][1]; ?>
" name="legal16Num" ></td>
				<?php if ($this->_tpl_vars['credentialsData'][16][2] == '是'): ?>
				<td>
				...
				<?php endif; ?>
				<td><input type="text" value="<?php echo $this->_tpl_vars['credentialsData'][16][3]; ?>
" id="legal16Deadline" name="legal16Deadline" ></td>
				<td><input type="text" value="<?php echo $this->_tpl_vars['credentialsData'][16][4]; ?>
" id="legal16Deadlinend" name="legal16Deadlinend" ></td>
				<td><textarea cols="30" rows="2"  id="legal16Comm" name="legal16Comm"><?php echo $this->_tpl_vars['credentialsData'][16][5]; ?>
</textarea></td>
			</tr>
		</table>
		<table class="formView" width="100%">
			...
			<?php if ($this->_tpl_vars['documentData'][1] == '是'): ?>	
			...
			<tr>
				<td class="tdhead">文件名</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][2]; ?>
" id="legalSafeName" name="legalSafeName"></td>
				<td class="tdhead">批复号</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][3]; ?>
" id="legalSafeNum" name="legalSafeNum"></td>
			</tr>
			<tr>
				<td class="tdhead">批复单位</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][4]; ?>
" id="legalSafeOrgan" name="legalSafeOrgan"></td>
				<td class="tdhead">批复时间</td><td><input type="text" class="datepicker" value="<?php echo $this->_tpl_vars['documentData'][5]; ?>
" id="legalSafeTime" name="legalSafeTime"></td>
			</tr>
			<tr>
				<td class="tdhead">有效期起始</td><td><input type="text" class="datepicker" value="<?php echo $this->_tpl_vars['documentData'][6]; ?>
" id="legalSafeDeadline" name="legalSafeDeadline"></td>
				<td class="tdhead">有效期至</td><td><input type="text" id="legalSafeDeadlinend" class="datepicker" onchange= "loadchecktime(this)" value="<?php echo $this->_tpl_vars['documentData'][7]; ?>
...
" name="legalSafeDeadlinend" disabled="disabled"></td>
			...
			<tr>
				<td class="tdtitle" colspan=4>《水土保持方案》批复
					<?php if ($this->_tpl_vars['documentData'][8] == '是'): ?>		
			...
			<tr>
				<td class="tdhead">文件名</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][9]; ?>
" id="legalWaterName" name="legalWaterName"></td>
				<td class="tdhead">批复号</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][10]; ?>
" id="legalWaterNum" name="legalWaterNum"></td>
			</tr>
			<tr>
				<td class="tdhead">批复单位</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][11]; ?>
" id="legalWaterOrgan" name="legalWaterOrgan"></td>
				<td class="tdhead">批复时间</td><td><input type="text" class="datepicker" value="<?php echo $this->_tpl_vars['documentData'][12]; ?>
" id="legalWaterTime" name="legalWaterTime"></td>
			</tr>
			<tr>
				<td class="tdhead">有效期起始</td><td><input type="text" class="datepicker" value="<?php echo $this->_tpl_vars['documentData'][13]; ?>
" id="legalWaterDeadline" name="legalWaterDeadline"></td>
				<td class="tdhead">有效期至</td><td><input type="text" id="legalWaterDeadlinend" class="datepicker" onchange= "loadchecktime(this)" value="<?php echo $this->_tpl_vars['documentData'][14]; ?>
...
" name="legalWaterDeadlinend" disabled="disabled"></td>
			...
			<tr>
				...
				<?php if ($this->_tpl_vars['documentData'][15] == '是'): ?>		
			...
			<tr>
				<td class="tdhead">文件名</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][16]; ?>
" id="legalLandName" name="legalLandName"></td>
				<td class="tdhead">批复号</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][17]; ?>
" id="legalLandNum" name="legalLandNum"></td>
			</tr>
			<tr>
				<td class="tdhead">批复单位</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][18]; ?>
" id="legalLandOrgan" name="legalLandOrgan"></td>
				<td class="tdhead">批复时间</td><td><input type="text" class="datepicker" value="<?php echo $this->_tpl_vars['documentData'][19]; ?>
" id="legalLandTime" name="legalLandTime"></td>
			</tr>
			<tr>
				<td class="tdhead">有效期起始</td><td><input type="text" class="datepicker" value="<?php echo $this->_tpl_vars['documentData'][20]; ?>
" id="legalLandDeadline" name="legalLandDeadline"></td>
				<td class="tdhead">有效期至</td><td><input type="text" id="legalLandDeadlinend" class="datepicker" onchange= "loadchecktime(this)" value="<?php echo $this->_tpl_vars['documentData'][21]; ?>
...
" name="legalLandDeadlinend" disabled="disabled"></td>
			...
			<tr>
				...
				<?php if ($this->_tpl_vars['documentData'][22] == '是'): ?>	
			...
			<tr>
				<td class="tdhead">文件名</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][23]; ?>
" id="legalHuanjingpifuName" name="legalHuanjingpifuName"></td>
				<td class="tdhead">批复号</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][24]; ?>
" id="legalHuanjingpifuNum" name="legalHuanjingpifuNum"></td>
			</tr>
			<tr>
				<td class="tdhead">批复单位</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][25]; ?>
" id="legalHuanjingpifuOrgan" name="legalHuanjingpifuOrgan"></td>
				<td class="tdhead">批复时间</td><td><input type="text" class="datepicker" value="<?php echo $this->_tpl_vars['documentData'][26]; ?>
" id="legalHuanjingpifuTime" name="legalHuanjingpifuTime"></td>
			</tr>
			<tr>
				<td class="tdhead">有效期起始</td><td><input type="text" class="datepicker" value="<?php echo $this->_tpl_vars['documentData'][27]; ?>
" id="legalHuanjingpifuDeadline" name="legalHuanjingpifuDeadline"></td>
				<td class="tdhead">有效期至</td><td><input type="text"  id= "legalHuanjingpifuDeadlinend" class="datepicker" onchange= "loadchecktime(this)" value="<?php echo $this->_tpl_vars['documentData'][28]; ?>
...
" name="legalHuanjingpifuDeadlinend" disabled="disabled"></td>
			...
			<tr>
				...
				<?php if ($this->_tpl_vars['documentData'][29] == '是'): ?>	
			...
			<tr>
				<td class="tdhead">文件名</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][30]; ?>
" id="legalDizhipifuName" name="legalDizhipifuName"></td>
				<td class="tdhead">批复号</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][31]; ?>
" id="legalDizhipifuNum" name="legalDizhipifuNum"></td>
			</tr>
			<tr>
				<td class="tdhead">批复单位</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][32]; ?>
" id="legalDizhipifuOrgan" name="legalDizhipifuOrgan"></td>
				<td class="tdhead">批复时间</td><td><input type="text" class="datepicker" value="<?php echo $this->_tpl_vars['documentData'][33]; ?>
" id="legalDizhipifuTime" name="legalDizhipifuTime"></td>
			</tr>
			<tr>
				<td class="tdhead">有效期起始</td><td><input type="text" class="datepicker" value="<?php echo $this->_tpl_vars['documentData'][34]; ?>
" id="legalDizhipifuDeadline" name="legalDizhipifuDeadline"></td>
				<td class="tdhead">有效期至</td><td><input type="text" id = "legalDizhipifuDeadlinend" class="datepicker" onchange= "loadchecktime(this)" value="<?php echo $this->_tpl_vars['documentData'][35]; ?>
...
" name="legalDizhipifuDeadlinend" disabled="disabled"></td>
			...
			<tr>
				...
				<?php if ($this->_tpl_vars['documentData'][36] == '是'): ?>	
			...
			<tr>
				<td class="tdhead">文件名</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][37]; ?>
" id="legalZaihaipifuName" name="legalZaihaipifuName"></td>
				<td class="tdhead">批复号</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][38]; ?>
" id="legalZaihaipifuNum" name="legalZaihaipifuNum"></td>
			</tr>
			<tr>
				<td class="tdhead">批复单位</td><td><input type="text" value="<?php echo $this->_tpl_vars['documentData'][39]; ?>
" id="legalZaihaipifuOrgan" name="legalZaihaipifuOrgan"></td>
				<td class="tdhead">批复时间</td><td><input type="text" class="datepicker" value="<?php echo $this->_tpl_vars['documentData'][40]; ?>
" id="legalZaihaipifuTime" name="legalZaihaipifuTime"></td>
			</tr>
			<tr>
				<td class="tdhead">有效期起始</td><td><input type="text" class="datepicker" value="<?php echo $this->_tpl_vars['documentData'][41]; ?>
" id="legalZaihaipifuDeadline" name="legalZaihaipifuDeadline"></td>
				<td class="tdhead">有效期至</td><td><input type="text" id = "legalZaihaipifuDeadlinend" class="datepicker" onchange= "loadchecktime(this)" value="<?php echo $this->_tpl_vars['documentData'][42]; ?>
...
" name="legalZaihaipifuDeadlinend" disabled="disabled"></td>
		...
		<table class="formView" width="100%">
			...
			<tr>
				...
				<td width="30%"><input type="text"  value="<?php echo $this->_tpl_vars['taxData'][1]; ?>
" name="legalFeeRecom" ></td>
				<td class="tdhead">已缴税金总额</td>
				<td width="30%"><input type="text"  value="<?php echo $this->_tpl_vars['taxData'][2]; ?>
" name="legalFeeOver" ></td>
			</tr>
			<tr>
				<td class="tdhead">已缴资源税</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['taxData'][3]; ?>
" name="legalFeeResource" ></td>
				<td class="tdhead">已缴增值税</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['taxData'][4]; ?>
" name="legalFeeValueadd" ></td>	
			</tr>	
			<tr>
				<td class="tdhead">已缴企业所得税</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['taxData'][5]; ?>
" name="legalFeeCompany" ></td>
				<td class="tdhead">应缴税金</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['taxData'][6]; ?>
" name="legalFeeTopay" ></td>
			</tr>	
			<tr>  
				<td class="tdhead">欠缴税金</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['taxData'][7]; ?>
" name="legalFeeNotpay" ></td>
				<td class="tdhead">保证金</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['taxData'][8]; ?>
" name="legalFeeEnsure" ></td>
			</tr>		
			<tr>
				<td class="tdhead">矿山环境治理保证金</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['taxData'][9]; ?>
" name="legalFeeEnvironment"></td>
				<td class="tdhead">土地复垦保证金</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['taxData'][10]; ?>
" name="legalFeeLand" ></td>
			...
			<tr>
				...
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['priceData'][1]; ?>
" name="legalPriceTopay"  ></td>
				<td class="tdhead">已缴价款额度</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['priceData'][2]; ?>
" name="legalPricePayed"  ></td>
			</tr>
			<tr>
				<td class="tdhead">欠缴价款额度</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['priceData'][3]; ?>
" name="legalPriceNopay"  ></td>
				<td class="tdhead">应缴款时间</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['priceData'][4]; ?>
" name="legalPriceTime"  ></td>
			</tr>
			<tr>	
				<td class='tdhead'>两年内无安全生产责任事故</td>
				<td colspan=3><textarea cols="60" rows="2" name="legalAccident"><?php echo $this->_tpl_vars['priceData'][5]; ?>
</textarea></td>
			</tr>
			<tr>	
			...
			<tr>
				...
				<?php if ($this->_tpl_vars['accidentData'][1] == '是'): ?>
				<td>		
				...
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['accidentData'][2]; ?>
" id="legalAccidentPlace" name="legalAccidentPlace" width="100%"></td>
			</tr>
			<tr>
				<td class="tdhead">发生时间</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['accidentData'][3]; ?>
" id="legalAccidentTime" name="legalAccidentTime"  ></td>
				<td class="tdhead">处理情况</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['accidentData'][4]; ?>
...
" id="legalAccidentDeal" name="legalAccidentDeal" disabled="disabled" ></td>
			...
			<tr>
				<td class='tdhead'>是否有安全事故</td>
				<?php if ($this->_tpl_vars['accidentData'][5] == '是'): ?>
				<td>		
				...
				<td class="tdhead">事故地点</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['accidentData'][6]; ?>
" id="legalPollutePlace" name="legalPollutePlace" width="100%"></td>
			</tr>
			<tr>
				<td class="tdhead">发生时间</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['accidentData'][7]; ?>
" id="legalPolluteTime" name="legalPolluteTime"  ></td>
				<td class="tdhead">处理情况</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['accidentData'][8]; ?>
...
" id="legalPolluteDeal" name="legalPolluteDeal" disabled="disabled" ></td>
			...
			<tr>
				...
				<?php if ($this->_tpl_vars['accidentData'][9] == '是'): ?>
				<td>		
				...
				<td><textarea cols="30" rows="2" id="legalPunishReson" name="legalPunishReson" width="100%"><?php echo $this->_tpl_vars['accidentData'][10]; ?>
</textarea></td>
			</tr>
			<tr>
				<td class="tdhead">处罚时间</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['accidentData'][11]; ?>
" id="legalPunishTime" name="legalPunishTime"  ></td>
				<td class="tdhead">责任人</td>
				<td ><input type="text"  value="<?php echo $this->_tpl_vars['accidentData'][12]; ?>
" id="legalPunishPerson" name="legalPunishPerson"  ></td>
				...
				<td class="tdhead">处罚原因</td>
				<td><textarea cols="30" rows="2" id="legalPunishReson" name="legalPunishReson" width="100%" disabled="disabled"><?php echo $this->_tpl_vars['accidentData'][10]; ?>
</textarea></td>
			</tr>
			<tr>
				<td class="tdhead">处罚时间</td>
...
" id="legalPunishPerson" name="legalPunishPerson" disabled="disabled" ></td>
			...
			<tr>
				...
				<?php if ($this->_tpl_vars['safetyData'][1] == '是'): ?>
				<td class='tdtitle'>		
				...
				<?php if ($this->_tpl_vars['safetyData'][2] == '是'): ?>
				<td class='tdtitle'>		
			...
			<tr>
				...
				<?php if ($this->_tpl_vars['safetyData'][3] == '是'): ?>
				<td>		
				...
				<?php if ($this->_tpl_vars['safetyData'][4] == '是'): ?>
				<td>		
			...
			<tr>
				...
				<?php if ($this->_tpl_vars['safetyData'][5] == '是'): ?>
				<td>		
				...
				<?php if ($this->_tpl_vars['safetyData'][6] == '是'): ?>
				<td>		
			...
			<tr>
				...
				<?php if ($this->_tpl_vars['safetyData'][7] == '是'): ?>
				<td>		
				...
				<?php if ($this->_tpl_vars['safetyData'][8] == '是'): ?>
				<td>		
	...
	<table class="formView" align="center" id="standard">
		...
		<tr>
			...
			<td colspan=3>
				<textarea cols="60" rows="4"  name="standardGrow"><?php echo $this->_tpl_vars['Institution_building'][1]; ?>
</textarea>
			</td>
		</tr>
		<tr>
			<td class='tdhead'>是否有为绿色矿山修改生产管理制度</td>
			<?php if ($this->_tpl_vars['Institution_building'][2] == '是'): ?>
				<td>		
				...
				<td><input type="text"  value="<?php echo $this->_tpl_vars['Institution_building'][3]; ?>
...
" class="datepicker" id="standardGrowTime" name="standardGrowTime" disabled="disabled"></td>
		...
		<tr>
			...
			<td colspan=3>
				<textarea cols="60" rows="4"  name="standardGrowChange"><?php echo $this->_tpl_vars['Institution_building'][4]; ?>
</textarea>
			</td>
		</tr>
		<tr>
			...
			<td colspan=3>
				<textarea cols="60" rows="4"  name="standardGrowComment"><?php echo $this->_tpl_vars['Institution_building'][5]; ?>
</textarea>
			</td>
		</tr>
	</table>
	<table class="formView" width="100%">
		...
		<tr>
			...
			<?php if ($this->_tpl_vars['System_improvement'][1] == '是'): ?>
				<td width="10%">		
			...
			<?php if ($this->_tpl_vars['System_improvement'][2] == '是'): ?>
				<td width="10%">		
		...
		<tr>
			...
			<?php if ($this->_tpl_vars['System_improvement'][3] == '是'): ?>
				<td>		
			...
			<?php if ($this->_tpl_vars['System_improvement'][4] == '是'): ?>
				<td>		
		...
		<tr>
			...
			<?php if ($this->_tpl_vars['System_improvement'][5] == '是'): ?>
				<td>		
			...
			<?php if ($this->_tpl_vars['System_improvement'][6] == '是'): ?>
				<td>		
		...
		<tr>
			...
			<?php if ($this->_tpl_vars['System_improvement'][7] == '是'): ?>
				<td>		
			...
			<?php if ($this->_tpl_vars['System_improvement'][8] == '是'): ?>
				<td>		
		...
		<tr>
			...
			<?php if ($this->_tpl_vars['System_improvement'][9] == '是'): ?>
				<td>		
			...
			<?php if ($this->_tpl_vars['System_improvement'][10] == '是'): ?>
				<td>		
		...
		<tr>
			...
			<?php if ($this->_tpl_vars['System_improvement'][11] == '是'): ?>
				<td>		
		...
		<tr>
			...
			<td colspan=3><textarea cols="60" rows="2" name="standardOther" width="100%"><?php echo $this->_tpl_vars['System_improvement'][12]; ?>
</textarea></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="tdhead">整体情况</td>
			<td colspan=3><textarea cols="60" rows="4" name="standardWorker" width="100%"><?php echo $this->_tpl_vars['Training_system'][1]; ?>
</textarea></td>
		</tr>	
		<tr>
			<td class="tdhead">每年组织培训次数</td>
			<td colspan=3><input type="text"  value="<?php echo $this->_tpl_vars['Training_system'][2]; ?>
" name="standardWorkerCount"  ><input type="button" id="button_standardWorkerCount" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_standardWorkerCount">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][1]; ?>
" name="standardWorkerCount_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][2]; ?>
" name="standardWorkerCount_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][3]; ?>
" name="standardWorkerCount_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][4]; ?>
" name="standardWorkerCount_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][5]; ?>
" name="standardWorkerCount_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][6]; ?>
" name="standardWorkerCount_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][7]; ?>
" name="standardWorkerCount_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][8]; ?>
" name="standardWorkerCount_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][9]; ?>
" name="standardWorkerCount_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][10]; ?>
" name="standardWorkerCount_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][11]; ?>
" name="standardWorkerCount_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][12]; ?>
" name="standardWorkerCount_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Number_training'][13]; ?>
" name="standardWorkerCount_pre5real"></td>	  
	...
	<table class="formView" align="center" width='100%'>
		<tr>
			...
			<td width="40%"><input type="text"  value="<?php echo $this->_tpl_vars['Training_system'][3]; ?>
" name="standardWorkerCost"  ><input type="button" id="button_standardWorkerCost" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_standardWorkerCost">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][1]; ?>
" name="standardWorkerCost_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][2]; ?>
" name="standardWorkerCost_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][3]; ?>
" name="standardWorkerCost_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][4]; ?>
" name="standardWorkerCost_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][5]; ?>
" name="standardWorkerCost_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][6]; ?>
" name="standardWorkerCost_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][7]; ?>
" name="standardWorkerCost_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][8]; ?>
" name="standardWorkerCost_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][9]; ?>
" name="standardWorkerCost_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][10]; ?>
" name="standardWorkerCost_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][11]; ?>
" name="standardWorkerCost_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][12]; ?>
" name="standardWorkerCost_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['Training_funds'][13]; ?>
" name="standardWorkerCost_pre5real"></td>	  
	...
	<table class="formView" width="100%">
		<tr>
			...
			<?php if ($this->_tpl_vars['Environmental_certification'][1] == '是'): ?>	
		...
		<tr>
			...
			<td><input type="text"  value="<?php echo $this->_tpl_vars['Environmental_certification'][2]; ?>
" id="standardIso4001Organ" name="standardIso4001Organ"  ></td>
			<td class="tdhead">认证时间</td>
			<td><input type="text"  value="<?php echo $this->_tpl_vars['Environmental_certification'][3]; ?>
" id="standardIso4001Time" name="standardIso4001Time" class="datepicker"  ></td>
			<td class="tdhead">有效期</td>
			<td><input type="text"  value="<?php echo $this->_tpl_vars['Environmental_certification'][4]; ?>
...
" id="standardIso4001Deadline" name="standardIso4001Deadline"  disabled="disabled"></td>
		...
		<tr>
			...
			<?php if ($this->_tpl_vars['Quality_certification'][1] == '是'): ?>		
		...
		<tr>
			<td class="tdhead">认证单位</td>
			<td><input type="text"  value="<?php echo $this->_tpl_vars['Quality_certification'][2]; ?>
" id="standardIso9001Organ" name="standardIso9001Organ"  ></td>
			<td class="tdhead">认证时间</td>
			<td><input type="text"  value="<?php echo $this->_tpl_vars['Quality_certification'][3]; ?>
" id="standardIso9001Time" name="standardIso9001Time" class="datepicker"  ></td>
			<td class="tdhead">有效期</td>
			<td><input type="text"  value="<?php echo $this->_tpl_vars['Quality_certification'][4]; ?>
...
?>
	...
	<?php if ($this->_tpl_vars['o']['_2'] == '煤矿' && $this->_tpl_vars['o']['_3'] == '主矿种'): ?>
	<table class="formView" align="center" id="complex" width="100%">
		<tr>
			<td class="tdtitle" colspan=4 style="background:#CCFFFF">主矿种：<?php echo $this->_tpl_vars['o']['_2']; ?>
</td>
		</tr>
		<tr>
			<td class="tdhead">采区回采率(%)</td>
			<td width="30%">
				<input type="text"  value="<?php echo $this->_tpl_vars['o']['_4']; ?>
" name="meiCqhc[]" style="width:80px">
				<input type="button" class="button_xiangqing" value="详情" style="width:50px"/>
			</td>
			<td class="tdhead">原煤入选率(%)</td>
			<td width="30%">
				<input type="text"  value="<?php echo $this->_tpl_vars['o']['_18']; ?>
" name="meiYmrx[]" style="width:80px">
...
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_5']; ?>
" name="meiCqhc3qiansj[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_6']; ?>
" name="meiCqhc2qiansj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_7']; ?>
" name="meiCqhc1qiansj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_8']; ?>
" name="meiCqhc1houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_9']; ?>
" name="meiCqhc1housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_10']; ?>
" name="meiCqhc2houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_11']; ?>
" name="meiCqhc2housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_12']; ?>
" name="meiCqhc3houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_13']; ?>
" name="meiCqhc3housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_14']; ?>
" name="meiCqhc4houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_15']; ?>
" name="meiCqhc4housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_16']; ?>
" name="meiCqhc5houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_17']; ?>
" name="meiCqhc5housj[]"></td>	  
	...
	<table align="center" style="display:none;" class="formView" id="ore53xkhs">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_19']; ?>
" name="meiYmrx3qiansj[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_20']; ?>
" name="meiYmrx2qiansj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_21']; ?>
" name="meiYmrx1qiansj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_22']; ?>
" name="meiYmrx1houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_23']; ?>
" name="meiYmrx1housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_24']; ?>
" name="meiYmrx2houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_25']; ?>
" name="meiYmrx2housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_26']; ?>
" name="meiYmrx3houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_27']; ?>
" name="meiYmrx3housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_28']; ?>
" name="meiYmrx4houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_29']; ?>
" name="meiYmrx4housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_30']; ?>
" name="meiYmrx5houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_31']; ?>
	...
	<table class="formView" align="center" width="100%">
		<tr>
			<td class="tdhead" colspan=4>煤矸石与共伴生资源综合利用率(%)
				<input type="text"value="<?php echo $this->_tpl_vars['o']['_32']; ?>
"  name="meiMgsgbs[]"><input type="button" class="button_xiangqing" value="详情"/>
		</tr>
	</table><!-- 煤矸石与共伴生资源综合利用率 -->
	<table align="center" style="display:none;" class="formView" id="ore53xkhs">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_33']; ?>
" name="meiMgsgbs3qiansj[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_34']; ?>
" name="meiMgsgbs2qiansj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_35']; ?>
" name="meiMgsgbs1qiansj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_36']; ?>
" name="meiMgsgbs1houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_37']; ?>
" name="meiMgsgbs1housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_38']; ?>
" name="meiMgsgbs2houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_39']; ?>
" name="meiMgsgbs2housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_40']; ?>
" name="meiMgsgbs3houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_41']; ?>
" name="meiMgsgbs3housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_42']; ?>
" name="meiMgsgbs4houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_43']; ?>
" name="meiMgsgbs4housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_44']; ?>
" name="meiMgsgbs5houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_45']; ?>
" name="meiMgsgbs5housj[]"></td>	  
	...
	<table class="formView" align="center" width="100%">
		<tr>
			...
			<td width="30%">
				<input type="text"  value="<?php echo $this->_tpl_vars['o']['_46']; ?>
" name="meiKjs[]" style="width:80px">
				<input type="button" class="button_xiangqing" value="详情" style="width:50px"/>
			</td>
			<td class="tdhead">煤矸石综合利用率(%)</td>
			<td width="30%">
				<input type="text"  value="<?php echo $this->_tpl_vars['o']['_60']; ?>
" name="meiMgszhly[]" style="width:80px">
				<input type="button" class="button_xiangqing1" value="详情" style="width:50px"/>
			</td>
		</tr>
	</table><!-- 矿井水综合利用率 -->
	<table align="center" style="display:none;" class="formView" id="ore53xkhs">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_47']; ?>
" name="meiKjs3qiansj[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_48']; ?>
" name="meiKjs2qiansj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_49']; ?>
" name="meiKjs1qiansj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_50']; ?>
" name="meiKjs1houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_51']; ?>
" name="meiKjs1housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_52']; ?>
" name="meiKjs2houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_53']; ?>
" name="meiKjs2housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_54']; ?>
" name="meiKjs3houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_55']; ?>
" name="meiKjs3housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_56']; ?>
" name="meiKjs4houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_57']; ?>
" name="meiKjs4housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_58']; ?>
" name="meiKjs5houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_59']; ?>
" name="meiKjs5housj[]"></td>	  
	...
	<table align="center" style="display:none;" class="formView" id="ore53xkhs">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_61']; ?>
" name="meiMgszhly3qiansj[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_62']; ?>
" name="meiMgszhly2qiansj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_63']; ?>
" name="meiMgszhly1qiansj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_64']; ?>
" name="meiMgszhly1houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_65']; ?>
" name="meiMgszhly1housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_66']; ?>
" name="meiMgszhly2houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_67']; ?>
" name="meiMgszhly2housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_68']; ?>
" name="meiMgszhly3houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_69']; ?>
" name="meiMgszhly3housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_70']; ?>
" name="meiMgszhly4houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_71']; ?>
" name="meiMgszhly4housj[]"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_72']; ?>
" name="meiMgszhly5houjh[]"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_73']; ?>
...
<?php elseif ($this->_tpl_vars['o']['_2'] != '煤矿' && $this->_tpl_vars['o']['_3'] == '主矿种'): ?>
<table class="formView" align="center" width="100%">
	<tr>
	...
	<tr>
		...
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_74']; ?>
" name="kaicaihuicai[]" style="width:80px">
			<input type="button" class="button_xiangqing" value="详情" style="width:50px"/>
		</td>
		<td class="tdhead">选矿回收率(%)</td>
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_88']; ?>
" name="xkhs[]" style="width:80px">
			<input type="button" class="button_xiangqing1" value="详情" style="width:50px"/>
		</td>
	</tr>
</table><!-- 开采回采率 -->
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_75']; ?>
" name="kaicaihuicai3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_76']; ?>
" name="kaicaihuicai2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_77']; ?>
" name="kaicaihuicai1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_78']; ?>
" name="kaicaihuicai1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_79']; ?>
" name="kaicaihuicai1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_80']; ?>
" name="kaicaihuicai2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_81']; ?>
" name="kaicaihuicai2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_82']; ?>
" name="kaicaihuicai3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_83']; ?>
" name="kaicaihuicai3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_84']; ?>
" name="kaicaihuicai4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_85']; ?>
" name="kaicaihuicai4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_86']; ?>
" name="kaicaihuicai5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_87']; ?>
...
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_89']; ?>
" name="xkhs3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_90']; ?>
" name="xkhs2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_91']; ?>
" name="xkhs1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_92']; ?>
" name="xkhs1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_93']; ?>
" name="xkhs1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_94']; ?>
" name="xkhs2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_95']; ?>
" name="xkhs2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_96']; ?>
" name="xkhs3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_97']; ?>
" name="xkhs3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_98']; ?>
" name="xkhs4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_99']; ?>
" name="xkhs4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_100']; ?>
" name="xkhs5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_101']; ?>
" name="xkhs5housj[]"></td>	  
	</tr>
</table><!-- 5-3 -->
...
<table class="formView" align="center" width="100%">
	<tr>
		...
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_102']; ?>
" name="caixuanzh[]" style="width:80px">
			<input type="button" class="button_xiangqing" value="详情" style="width:50px"/>
		</td>
		<td class="tdhead">综合利用率(%)</td>
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_116']; ?>
" name="zhly[]" style="width:80px">
			<input type="button" class="button_xiangqing1" value="详情" style="width:50px"/>
		</td>
	</tr>
</table><!-- 采选综合回收率 -->
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_103']; ?>
" name="caixuanzh3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_104']; ?>
" name="caixuanzh2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_105']; ?>
" name="caixuanzh1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_106']; ?>
" name="caixuanzh1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_107']; ?>
" name="caixuanzh1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_108']; ?>
" name="caixuanzh2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_109']; ?>
" name="caixuanzh2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_110']; ?>
" name="caixuanzh3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_111']; ?>
" name="caixuanzh3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_112']; ?>
" name="caixuanzh4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_113']; ?>
" name="caixuanzh4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_114']; ?>
" name="caixuanzh5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_115']; ?>
...
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_117']; ?>
" name="zhly3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_118']; ?>
" name="zhly2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_119']; ?>
" name="zhly1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_120']; ?>
" name="zhly1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_121']; ?>
" name="zhly1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_122']; ?>
" name="zhly2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_123']; ?>
" name="zhly2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_124']; ?>
" name="zhly3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_125']; ?>
" name="zhly3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_126']; ?>
" name="zhly4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_127']; ?>
" name="zhly4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_128']; ?>
" name="zhly5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_129']; ?>
" name="zhly5housj[]"></td>	  
	</tr>
</table><!-- 5-3 -->
...
<table class="formView" align="center" width="100%">
	<tr>
		...
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_130']; ?>
" name="kczyzhly[]" style="width:80px">
			<input type="button" class="button_xiangqing" value="详情" style="width:50px"/>
		</td>
		<td class="tdhead">矿产资源总回收率(%)</td>
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_144']; ?>
" name="kczyzongzhly[]" style="width:80px">
			<input type="button" class="button_xiangqing1" value="详情" style="width:50px"/>
		</td>
	</tr>
</table><!-- 矿产资源综合利用率 -->
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_131']; ?>
" name="kczyzhly3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_132']; ?>
" name="kczyzhly2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_133']; ?>
" name="kczyzhly1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_134']; ?>
" name="kczyzhly1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_135']; ?>
" name="kczyzhly1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_136']; ?>
" name="kczyzhly2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_137']; ?>
" name="kczyzhly2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_138']; ?>
" name="kczyzhly3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_139']; ?>
" name="kczyzhly3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_140']; ?>
" name="kczyzhly4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_141']; ?>
" name="kczyzhly4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_142']; ?>
" name="kczyzhly5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_143']; ?>
...
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_145']; ?>
" name="kczyzongzhly3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_146']; ?>
" name="kczyzongzhly2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_147']; ?>
" name="kczyzongzhly1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_148']; ?>
" name="kczyzongzhly1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_149']; ?>
" name="kczyzongzhly1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_150']; ?>
" name="kczyzongzhly2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_151']; ?>
" name="kczyzongzhly2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_152']; ?>
" name="kczyzongzhly3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_153']; ?>
" name="kczyzongzhly3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_154']; ?>
" name="kczyzongzhly4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_155']; ?>
" name="kczyzongzhly4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_156']; ?>
" name="kczyzongzhly5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_157']; ?>
...
<table class="formView" align="center" width="100%">
	<tr>
		...
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_158']; ?>
" name="ylhs[]" style="width:80px">
			<input type="button" class="button_xiangqing" value="详情" style="width:50px"/>
		</td>
		<td class="tdhead">共伴生矿资源综合利用率(%)</td>
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_172']; ?>
" name="gongbansheng[]" style="width:80px">
			<input type="button" class="button_xiangqing1" value="详情" style="width:50px"/>
		</td>
	</tr>
</table><!-- 冶炼回收率 -->
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_159']; ?>
" name="ylhs3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_160']; ?>
" name="ylhs2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_161']; ?>
" name="ylhs1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_162']; ?>
" name="ylhs1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_163']; ?>
" name="ylhs1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_164']; ?>
" name="ylhs2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_165']; ?>
" name="ylhs2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_166']; ?>
" name="ylhs3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_167']; ?>
" name="ylhs3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_168']; ?>
" name="ylhs4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_169']; ?>
" name="ylhs4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_170']; ?>
" name="ylhs5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_171']; ?>
" name="ylhs5housj[]"></td>	  
	</tr>
</table>	<!-- 5-3 -->
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_173']; ?>
" name="gongbansheng3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_174']; ?>
" name="gongbansheng2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_175']; ?>
" name="gongbansheng1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_176']; ?>
" name="gongbansheng1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_177']; ?>
" name="gongbansheng1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_178']; ?>
" name="gongbansheng2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_179']; ?>
" name="gongbansheng2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_180']; ?>
" name="gongbansheng3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_181']; ?>
" name="gongbansheng3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_182']; ?>
" name="gongbansheng4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_183']; ?>
" name="gongbansheng4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_184']; ?>
" name="gongbansheng5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_185']; ?>
...
<table class="formView" align="center" width="100%">
	<tr>
		<td class="tdhead">矿井水综合利用率(%)</td>
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_186']; ?>
" name="jingshui[]" style="width:80px">
			<input type="button" class="button_xiangqing" value="详情" style="width:50px"/>
		</td>
		<td class="tdhead">尾矿综合利用率(%)</td>
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_200']; ?>
" name="weikuang[]" style="width:80px">
			<input type="button" class="button_xiangqing1" value="详情" style="width:50px"/>
		</td>
	</tr>
</table><!-- 矿井水综合利用率 -->
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_187']; ?>
" name="jingshui3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_188']; ?>
" name="jingshui2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_189']; ?>
" name="jingshui1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_190']; ?>
" name="jingshui1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_191']; ?>
" name="jingshui1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_192']; ?>
" name="jingshui2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_193']; ?>
" name="jingshui2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_194']; ?>
" name="jingshui3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_195']; ?>
" name="jingshui3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_196']; ?>
" name="jingshui4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_197']; ?>
" name="jingshui4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_198']; ?>
" name="jingshui5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_199']; ?>
...
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_201']; ?>
" name="weikuang3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_202']; ?>
" name="weikuang2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_203']; ?>
" name="weikuang1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_204']; ?>
" name="weikuang1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_205']; ?>
" name="weikuang1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_206']; ?>
" name="weikuang2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_207']; ?>
" name="weikuang2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_208']; ?>
" name="weikuang3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_209']; ?>
" name="weikuang3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_210']; ?>
" name="weikuang4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_211']; ?>
" name="weikuang4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_212']; ?>
" name="weikuang5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_213']; ?>
...
<table class="formView" align="center" width="100%">
	<tr>
		...
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_214']; ?>
" name="feiqi[]" style="width:80px">
			<input type="button" class="button_xiangqing" value="详情" style="width:50px"/>
		</td>
		<td class="tdhead">废渣综合利用率(%)</td>
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_228']; ?>
" name="feizha[]" style="width:80px">
			<input type="button" class="button_xiangqing1" value="详情" style="width:50px"/>
...
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_215']; ?>
" name="feiqi3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_216']; ?>
" name="feiqi2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_217']; ?>
" name="feiqi1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_218']; ?>
" name="feiqi1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_219']; ?>
" name="feiqi1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_220']; ?>
" name="feiqi2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_221']; ?>
" name="feiqi2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_222']; ?>
" name="feiqi3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_223']; ?>
" name="feiqi3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_224']; ?>
" name="feiqi4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_225']; ?>
" name="feiqi4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_226']; ?>
" name="feiqi5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_227']; ?>
" name="feiqi5housj[]"></td>	  
	</tr>
</table>	<!-- 5-3 -->
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_229']; ?>
" name="feizha3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_230']; ?>
" name="feizha2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_231']; ?>
" name="feizha1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_232']; ?>
" name="feizha1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_233']; ?>
" name="feizha1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_234']; ?>
" name="feizha2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_235']; ?>
" name="feizha2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_236']; ?>
" name="feizha3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_237']; ?>
" name="feizha3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_238']; ?>
" name="feizha4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_239']; ?>
" name="feizha4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_240']; ?>
" name="feizha5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_241']; ?>
...
<table class="formView" align="center" width="100%">
	<tr>
		...
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_242']; ?>
" name="pinhua[]" style="width:80px">
			<input type="button" class="button_xiangqing" value="详情" style="width:50px"/>
		</td>
		<td class="tdhead">产率(%)</td>
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_256']; ?>
" name="chanlv[]" style="width:80px">
			<input type="button" class="button_xiangqing1" value="详情" style="width:50px"/>
		</td>
	</tr>
</table><!-- 贫化率 -->
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_243']; ?>
" name="pinhua3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_244']; ?>
" name="pinhua2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_245']; ?>
" name="pinhua1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_246']; ?>
" name="pinhua1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_247']; ?>
" name="pinhua1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_248']; ?>
" name="pinhua2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_249']; ?>
" name="pinhua2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_250']; ?>
" name="pinhua3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_251']; ?>
" name="pinhua3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_252']; ?>
" name="pinhua4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_253']; ?>
" name="pinhua4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_254']; ?>
" name="pinhua5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_255']; ?>
...
<table align="center" style="display:none;" class="formView" id="ore53xkhs">
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_257']; ?>
" name="chanlv3qiansj[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_258']; ?>
" name="chanlv2qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_259']; ?>
" name="chanlv1qiansj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_260']; ?>
" name="chanlv1houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_261']; ?>
" name="chanlv1housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_262']; ?>
" name="chanlv2houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_263']; ?>
" name="chanlv2housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_264']; ?>
" name="chanlv3houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_265']; ?>
" name="chanlv3housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_266']; ?>
" name="chanlv4houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_267']; ?>
" name="chanlv4housj[]"></td>
	</tr>
	<tr>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['o']['_268']; ?>
" name="chanlv5houjh[]"></td>
		<td class="tdhead"><?php echo $this->_tpl_vars['basedataArray'][0]->basedataJiqizhi+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['o']['_269']; ?>
...
<?php if ($this->_tpl_vars['o']['_3'] == '伴生矿种'): ?>
<table class="formView" align="center" width="100%">
	<tr>
		<tr>
			<td class="tdtitle" colspan=4 style="background:#CCFFFF">共伴生矿种：<?php echo $this->_tpl_vars['o']['_2']; ?>
</td>
		</tr>
		<td class="tdhead">选矿回收率(%)</td>
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_88']; ?>
" name="gbsXkhs[]" style="width:80px">
			<input type="button" class="button_xiangqing" value="详情" style="width:50px"/>
		</td>
		<td class="tdhead">冶炼回收率(%)</td>
		<td width="30%">
			<input type="text"  value="<?php echo $this->_tpl_vars['o']['_158']; ?>
" name="gbsYlhs[]" style="width:80px">
			<input type="button" class="button_xiangqing1" value="详情" style="width:50px"/>
		</td>
	</tr>
</table>
...
?>
	<tr>
		<td class='tdtitle' colspan=4> <?php echo $this->_tpl_vars['o']['_3']; ?>
:<?php echo $this->_tpl_vars['o']['_2']; ?>
</td>
	</tr>
	<td colspan=4>
		<table class="formView" align="center" width="90%">
			<tr>
				<td class="tdtitle" style="font:bold 14px" colspan=4>
					<?php if ($this->_tpl_vars['o']['_2'] == '煤矿'): ?>
						原煤入选率(%)<?php else: ?>选矿回收率(%)
					<?php endif; ?>
					<input type="button" onclick="addxkhslv(this.id,'<?php echo $this->_tpl_vars['o']['_o22']; ?>
...
');" id='xkhsbtn<?php echo $this->_tpl_vars['o']['_o22']; ?>
' value="添加"/>
				</td>
			</tr>
		</table>

		<table class="formView" align="center" id="orexkhsbtn<?php echo $this->_tpl_vars['o']['_o22']; ?>
" width="90%">	

			<tr>	
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_292']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_271']; ?>
" name="orexuankuanghuishou1[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orexuankuanghuishou1<?php echo $this->_tpl_vars['l'][30]; ?>
" >
				</td>
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_293']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_272']; ?>
" name="orexuankuanghuishou2[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orexuankuanghuishou2<?php echo $this->_tpl_vars['l'][30]; ?>
"  >
				</td>
			</tr>
			<tr>
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_294']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_273']; ?>
" name="orexuankuanghuishou3[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orexuankuanghuishou3<?php echo $this->_tpl_vars['l'][30]; ?>
">
				</td>
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_295']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_274']; ?>
" name="orexuankuanghuishou4[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orexuankuanghuishou4<?php echo $this->_tpl_vars['l'][30]; ?>
">
				</td>
			</tr>
			<tr>	
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_296']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_275']; ?>
" name="orexuankuanghuishou5[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orexuankuanghuishou5<?php echo $this->_tpl_vars['l'][30]; ?>
">
				</td>

				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_297']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_276']; ?>
" name="orexuankuanghuishou6[<?php echo $this->_tpl_vars['o']['_o22']; ?>
...
">
			...
			<tr>
				<td class="tdhead" colspan=4 width="90%">
					<?php if ($this->_tpl_vars['o']['_2'] == '煤矿'): ?>原煤入选率(%)<?php else: ?>选矿回收率(%)<?php endif; ?>
					<input type="text" value="<?php echo $this->_tpl_vars['o']['_270']; ?>
" name="orexuankuanghuishouvalue[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orexuankuanghuishouvalue<?php echo $this->_tpl_vars['o'][30]; ?>
">
				</td>
			</tr>
		</table>
...
').toggle();
 ...
 -->
		...
		<div id="orexkhsdiv<?php echo $this->_tpl_vars['o']['_o22']; ?>
">
		...
		<table class="formView" align="center" width="90%">
			<tr>
				<td class="tdtitle" colspan=4 style="font:bold 14px">
					<?php if ($this->_tpl_vars['o'][0] == '煤矿'): ?>采区回采率(%)<?php else: ?>开采回采率(%)<?php endif; ?><input type="button" onclick="addkchclv(this.id, <?php echo $this->_tpl_vars['o']['_o22']; ?>
...
');" id="kchcbtn<?php echo $this->_tpl_vars['o']['_o22']; ?>
" value="添加"/>
				</td>
			</tr>
		</table>
		<table class="formView" align="center" id="orekchcbtn<?php echo $this->_tpl_vars['o']['_o22']; ?>
" width="90%">
			<tr>	
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_299']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_278']; ?>
" name="orekaicaihuicai1[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orekaicaihuicai1<?php echo $this->_tpl_vars['k'][30]; ?>
">
				</td>
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_300']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_279']; ?>
" name="orekaicaihuicai2[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orekaicaihuicai2<?php echo $this->_tpl_vars['k'][30]; ?>
" >
				</td>
			</tr>
			<tr>	
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_301']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_280']; ?>
" name="orekaicaihuicai3[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orekaicaihuicai3<?php echo $this->_tpl_vars['k'][30]; ?>
">
				</td>
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_302']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_281']; ?>
" name="orekaicaihuicai4[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orekaicaihuicai4<?php echo $this->_tpl_vars['k'][30]; ?>
">
				</td>
			</tr>
			<tr>	
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_303']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_282']; ?>
" name="orekaicaihuicai5[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orekaicaihuicai5<?php echo $this->_tpl_vars['k'][30]; ?>
">
				</td>

				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_304']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_283']; ?>
" name="orekaicaihuicai6[<?php echo $this->_tpl_vars['o']['_o22']; ?>
...
">
			...
			<tr>
				<td class="tdhead" colspan=4 width="90%" >
					<?php if ($this->_tpl_vars['o']['_2'] == '煤矿'): ?>采区回采率(%)<?php else: ?>开采回采率(%)<?php endif; ?>
					<input type="text" value="<?php echo $this->_tpl_vars['o']['_277']; ?>
" name="orekaicaihuicaivalue[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orekaicaihuicaivalue<?php echo $this->_tpl_vars['o'][30]; ?>
">
				</td>
			</tr>
		</table>
		<div id="orekchcdiv<?php echo $this->_tpl_vars['o']['_o22']; ?>
">

		</div>

		<table class="formView" align="center" width="90%">
			<tr><td colspan=4 class="tdtitle" style="font:bold 14px">综合利用率(%)<input type="button" onclick="addzhlylv(this.id, <?php echo $this->_tpl_vars['o']['_o22']; ?>
...
');" id="zhlybtn<?php echo $this->_tpl_vars['o']['_o22']; ?>
" value="添加"/></td></tr>						
		</table>
		<table class="formView" align="center" id="orezhlybtn<?php echo $this->_tpl_vars['o']['_o22']; ?>
" width="90%">

			<tr>	
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_306']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_285']; ?>
" name="orezhly1[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orekaicaihuicai1<?php echo $this->_tpl_vars['y'][30]; ?>
">
				</td>
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_307']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_286']; ?>
" name="orezhly2[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orekaicaihuicai2<?php echo $this->_tpl_vars['y'][30]; ?>
" >
				</td>
			</tr>
			<tr>	
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_308']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_287']; ?>
" name="orezhly3[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orekaicaihuicai3<?php echo $this->_tpl_vars['y'][30]; ?>
">
				</td>
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_309']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_288']; ?>
" name="orezhly4[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orekaicaihuicai4<?php echo $this->_tpl_vars['y'][30]; ?>
">
				</td>
			</tr>
			<tr>	
				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_310']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_289']; ?>
" name="orezhly5[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]" id="orekaicaihuicai5<?php echo $this->_tpl_vars['y'][30]; ?>
">
				</td>

				<td class="tdhead" width="20%"><?php echo $this->_tpl_vars['o']['_311']; ?>
</td>
				<td width="10%">
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_290']; ?>
" name="orezhly6[<?php echo $this->_tpl_vars['o']['_o22']; ?>
...
">
			...
			<tr>
				<td class="tdhead" colspan=4 width="20%">综合利用率 
					<input type="text"  value="<?php echo $this->_tpl_vars['o']['_284']; ?>
" name="complexUserate[<?php echo $this->_tpl_vars['o']['_o22']; ?>
][]"  >
				</td>
			</tr>
		</table>
		<div id="orezhlydiv<?php echo $this->_tpl_vars['o']['_o22']; ?>
">
...
<?php endif; unset($_from); ?>	
	...
	<table class="formView" align="center" id="science" width="100%">
		<tr>
			<td class = 'tdtitle' colspan=4>科技创新投入占矿山企业总产值比重(%)<input   value="<?php echo $this->_tpl_vars['invested_proportion'][1]; ?>
" name="scienceRate"><input type="button" id="button_scienceRate" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_scienceRate">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][1]; ?>
" name="scienceRate_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][2]; ?>
" name="scienceRate_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][3]; ?>
" name="scienceRate_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][4]; ?>
" name="scienceRate_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][5]; ?>
" name="scienceRate_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][6]; ?>
" name="scienceRate_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][7]; ?>
" name="scienceRate_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][8]; ?>
" name="scienceRate_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][9]; ?>
" name="scienceRate_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][10]; ?>
" name="scienceRate_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][11]; ?>
" name="scienceRate_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][12]; ?>
" name="scienceRate_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['invested_proportion_35'][13]; ?>
" name="scienceRate_pre5real"></td>	  
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
			<td class = 'tdhead'>科技投入资金(万元)</td><td><input   value="<?php echo $this->_tpl_vars['invested_proportion'][2]; ?>
" name="scienceRateScimoney"></td>	
			<td class = 'tdhead'>总投资(万元)</td><td><input   value="<?php echo $this->_tpl_vars['invested_proportion'][3]; ?>
" name="scienceRateAllmoney"></td>	
		</tr>
		<!-- <tr>
			<td class = 'tdhead'>比重是否小于1%</td><td><input   value="<?php echo $this->_tpl_vars['invested_proportion'][4]; ?>
" name="scienceRateIsone"></td>
		...
		<tr>
			<td class = 'tdhead'>发明专利数量</td><td><input   value="<?php echo $this->_tpl_vars['patent'][1]; ?>
" name="sciencePatentCreat"></td>	
			<td class = 'tdhead'>实用新型专利数量</td><td><input   value="<?php echo $this->_tpl_vars['patent'][2]; ?>
" name="sciencePatentNewuse"></td>
		...
		<tr>
			<td class = 'tdhead'>初级职称人员及比重(%)</td><td><input   value="<?php echo $this->_tpl_vars['technical_staff'][1]; ?>
" name="scienceManrateLow"></td>	
			<td class = 'tdhead'>中级职称人员及比重(%)</td><td><input   value="<?php echo $this->_tpl_vars['technical_staff'][2]; ?>
" name="scienceManrateMid"></td>
		</tr>
		<tr>
			<td class = 'tdhead'>高级职称人员及比重(%)</td><td><input   value="<?php echo $this->_tpl_vars['technical_staff'][3]; ?>
" name="scienceManrateHigh"></td>
			<!-- <td class = 'tdhead'>总职工人数</td><td><input   value="<?php echo $this->_tpl_vars['technical_staff'][4]; ?>
" name="scienceManrateAll"></td> -->
	...
	<table class="formView" align="center" id="save_energy" width="100%">
		<tr>
			<td class = 'tdtitle' colspan=4>单位工业总产值电耗(千瓦时/（万元*年）)<input   value="<?php echo $this->_tpl_vars['power_consumption'][1]; ?>
" name="energyElect"><input type="button" id="button_energyElect" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_energyElect">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][1]; ?>
" name="energyElect_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][2]; ?>
" name="energyElect_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][3]; ?>
" name="energyElect_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][4]; ?>
" name="energyElect_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][5]; ?>
" name="energyElect_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][6]; ?>
" name="energyElect_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][7]; ?>
" name="energyElect_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][8]; ?>
" name="energyElect_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][9]; ?>
" name="energyElect_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][10]; ?>
" name="energyElect_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][11]; ?>
" name="energyElect_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][12]; ?>
" name="energyElect_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['power_consumption_35'][13]; ?>
" name="energyElect_pre5real"></td>	  
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
			<td class = 'tdhead'>年工业用电总量(千瓦时)</td><td><input   value="<?php echo $this->_tpl_vars['power_consumption'][2]; ?>
" name="energyElectUse"></td>
			<td class = 'tdhead'>年工业总产值(万元)</td><td><input   value="<?php echo $this->_tpl_vars['power_consumption'][3]; ?>
" name="energyElectProduct"></td>
		</tr>
		<tr>
			<td class = 'tdtitle' colspan=4>单位工业总产值水耗(立方米/万元)<input   value="<?php echo $this->_tpl_vars['water_consumption'][1]; ?>
" name="energyWater"><input type="button" id="button_energyWater" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_energyWater">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][1]; ?>
" name="energyWater_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][2]; ?>
" name="energyWater_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][3]; ?>
" name="energyWater_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][4]; ?>
" name="energyWater_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][5]; ?>
" name="energyWater_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][6]; ?>
" name="energyWater_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][7]; ?>
" name="energyWater_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][8]; ?>
" name="energyWater_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][9]; ?>
" name="energyWater_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][10]; ?>
" name="energyWater_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][11]; ?>
" name="energyWater_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][12]; ?>
" name="energyWater_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['water_consumption_35'][13]; ?>
" name="energyWater_pre5real"></td>	  
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
			<td class = 'tdhead'>年工业取水总量(立方米)</td><td><input   value="<?php echo $this->_tpl_vars['water_consumption'][2]; ?>
" name="energyWaterUse"></td>
			<td class = 'tdhead'>年工业总产值(万元)</td><td><input   value="<?php echo $this->_tpl_vars['water_consumption'][3]; ?>
" name="energyWaterProduct"></td>
		</tr>
		<tr>
			<td class = 'tdtitle' colspan=4>单位万元工业总产值能耗(吨/万元)<input   value="<?php echo $this->_tpl_vars['energy_consumption'][1]; ?>
" name="energyEnergy"><input type="button" id="button_energyEnergy" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_energyEnergy">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][1]; ?>
" name="energyEnergy_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][2]; ?>
" name="energyEnergy_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][3]; ?>
" name="energyEnergy_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][4]; ?>
" name="energyEnergy_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][5]; ?>
" name="energyEnergy_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][6]; ?>
" name="energyEnergy_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][7]; ?>
" name="energyEnergy_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][8]; ?>
" name="energyEnergy_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][9]; ?>
" name="energyEnergy_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][10]; ?>
" name="energyEnergy_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][11]; ?>
" name="energyEnergy_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][12]; ?>
" name="energyEnergy_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['energy_consumption_35'][13]; ?>
" name="energyEnergy_pre5real"></td>	  
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
			<td class = 'tdhead'>年工业能源消费量(吨)</td><td><input   value="<?php echo $this->_tpl_vars['energy_consumption'][2]; ?>
" name="energyEnergyUse"></td>
			<td class = 'tdhead'>年工业总产值(万元)</td><td><input   value="<?php echo $this->_tpl_vars['energy_consumption'][3]; ?>
" name="energyEnergyProduct"></td>
		</tr>
		<tr>
			<td class = 'tdtitle' colspan=4>矿山选矿废水重复利用率(%)<input   value="<?php echo $this->_tpl_vars['wastewater_use'][1]; ?>
" name="energyWaste"><input type="button" id="button_energyWaste" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_energyWaste">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][1]; ?>
" name="energyWaste_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][2]; ?>
" name="energyWaste_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][3]; ?>
" name="energyWaste_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][4]; ?>
" name="energyWaste_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][5]; ?>
" name="energyWaste_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][6]; ?>
" name="energyWaste_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][7]; ?>
" name="energyWaste_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][8]; ?>
" name="energyWaste_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][9]; ?>
" name="energyWaste_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][10]; ?>
" name="energyWaste_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][11]; ?>
" name="energyWaste_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][12]; ?>
" name="energyWaste_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['wastewater_use_35'][13]; ?>
" name="energyWaste_pre5real"></td>	  
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
			<td class = 'tdhead'>重复利用废水量(立方米)</td><td><input   value="<?php echo $this->_tpl_vars['wastewater_use'][2]; ?>
" name="energyWasteUse"></td>
			<td class = 'tdhead'>生产中取用的新水量(立方米)</td><td><input   value="<?php echo $this->_tpl_vars['wastewater_use'][3]; ?>
" name="energyWasteNew"></td>
		</tr>
		<tr>
			<td class = 'tdtitle' colspan=4>矿山固体废弃物综合利用率(%)<input   value="<?php echo $this->_tpl_vars['waste_utilization'][1]; ?>
" name="energyRubbish"><input type="button" id="button_energyRubbish" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_energyRubbish">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][1]; ?>
" name="energyRubbish_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][2]; ?>
" name="energyRubbish_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][3]; ?>
" name="energyRubbish_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][4]; ?>
" name="energyRubbish_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][5]; ?>
" name="energyRubbish_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][6]; ?>
" name="energyRubbish_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][7]; ?>
" name="energyRubbish_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][8]; ?>
" name="energyRubbish_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][9]; ?>
" name="energyRubbish_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][10]; ?>
" name="energyRubbish_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][11]; ?>
" name="energyRubbish_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][12]; ?>
" name="energyRubbish_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['waste_utilization_35'][13]; ?>
" name="energyRubbish_pre5real"></td>	  
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
			<td class = 'tdhead'>当年综合利用固体废弃物总量(吨)</td><td><input   value="<?php echo $this->_tpl_vars['waste_utilization'][2]; ?>
" name="energyRubbishUse"></td>
			<td class = 'tdhead'>当年固体废弃物产生量(吨)</td><td><input   value="<?php echo $this->_tpl_vars['waste_utilization'][3]; ?>
" name="energyRubbishProduct"></td>
		</tr>
		<tr>
			<td class = 'tdhead'>往年贮存量总和(吨)</td><td ><input   value="<?php echo $this->_tpl_vars['waste_utilization'][4]; ?>
" name="energyRubbishAll"></td>
		</tr>
		<tr>
			<td class = 'tdtitle' colspan=4>单位工业总产值SO2排放量(10^4 吨/万元)<input   value="<?php echo $this->_tpl_vars['sulfur_emissions'][1]; ?>
" name="energySo2"><input type="button" id="button_energySo2" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_energySo2">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][1]; ?>
" name="energySo2_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][2]; ?>
" name="energySo2_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][3]; ?>
" name="energySo2_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][4]; ?>
" name="energySo2_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][5]; ?>
" name="energySo2_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][6]; ?>
" name="energySo2_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][7]; ?>
" name="energySo2_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][8]; ?>
" name="energySo2_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][9]; ?>
" name="energySo2_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][10]; ?>
" name="energySo2_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][11]; ?>
" name="energySo2_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][12]; ?>
" name="energySo2_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['sulfur_emissions_35'][13]; ?>
" name="energySo2_pre5real"></td>	  
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
			<td class = 'tdhead'>年度矿区工业SO2排放量(10^4 吨)</td><td><input   value="<?php echo $this->_tpl_vars['sulfur_emissions'][2]; ?>
" name="energySo2Product"></td>
			<td class = 'tdhead'>年度矿区工业总产值指标(万元)</td><td ><input   value="<?php echo $this->_tpl_vars['sulfur_emissions'][3]; ?>
" name="energySo2Target"></td>
	...
	<table class="formView" align="center" id="envi_protect" width="100%">	
		<tr>
			<td class="tdtitle" colspan=4>绿化覆盖率(%)<input   value="<?php echo $this->_tpl_vars['coverage'][1]; ?>
" name="environmentRate"><input type="button" id="button_environmentRate" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_environmentRate">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][1]; ?>
" name="environmentRate_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][2]; ?>
" name="environmentRate_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][3]; ?>
" name="environmentRate_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][4]; ?>
" name="environmentRate_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][5]; ?>
" name="environmentRate_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][6]; ?>
" name="environmentRate_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][7]; ?>
" name="environmentRate_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][8]; ?>
" name="environmentRate_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][9]; ?>
" name="environmentRate_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][10]; ?>
" name="environmentRate_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][11]; ?>
" name="environmentRate_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][12]; ?>
" name="environmentRate_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['coverage_35'][13]; ?>
" name="environmentRate_pre5real"></td>	  
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
			<td class="tdhead">矿区内全部绿化种植垂直投影面积(平方千米)</td><td><input   value="<?php echo $this->_tpl_vars['coverage'][2]; ?>
" name="environmentRateGreen"></td>
			<td class="tdhead">矿区面积(平方千米)</td><td><input   value="<?php echo $this->_tpl_vars['coverage'][3]; ?>
" name="environmentRateArea"></td>
		...
		<tr>
			...
			<?php if ($this->_tpl_vars['standards'][1] == '是'): ?>
				<td width="15%">		
			...
			<?php if ($this->_tpl_vars['standards'][2] == '是'): ?>
				<td width="15%">		
			...
			<?php if ($this->_tpl_vars['standards'][3] == '是'): ?>
				<td width="15%">		
			...
			<?php if ($this->_tpl_vars['standards'][4] == '是'): ?>
				<td width="15%">		
		...
		<tr>
			...
			<td colspan=3>
				<textarea cols="60" rows="3" name="environmentIsDisaster"><?php echo $this->_tpl_vars['standards'][5]; ?>
</textarea>
			</td>
		</tr>
	</table>
	...
	<table class="formView" align="center" id="land_recovery" width='100%'>
		<tr>
			<td class="tdtitle" colspan=4>土地复垦率(%)<input   value="<?php echo $this->_tpl_vars['reclamation_rate'][1]; ?>
" name="reclamationRate"><input type="button" id="button_reclamationRate" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_reclamationRate">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][1]; ?>
" name="reclamationRate_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][2]; ?>
" name="reclamationRate_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][3]; ?>
" name="reclamationRate_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][4]; ?>
" name="reclamationRate_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][5]; ?>
" name="reclamationRate_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][6]; ?>
" name="reclamationRate_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][7]; ?>
" name="reclamationRate_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][8]; ?>
" name="reclamationRate_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][9]; ?>
" name="reclamationRate_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][10]; ?>
" name="reclamationRate_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][11]; ?>
" name="reclamationRate_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][12]; ?>
" name="reclamationRate_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['reclamation_rate_35'][13]; ?>
" name="reclamationRate_pre5real"></td>	  
		</tr>
	</table>
	<table class="formView" align="center" width='100%'>
		<tr>
			<td class="tdhead" >已复垦土地面积(平方千米)</td><td><input   value="<?php echo $this->_tpl_vars['reclamation_rate'][2]; ?>
" name="reclamationRateHave"></td>
			<td class="tdhead" >可复垦土地面积(平方千米)</td><td><input   value="<?php echo $this->_tpl_vars['reclamation_rate'][3]; ?>
" name="reclamationRateCan"></td>
		...
		<tr>
			<td class="tdhead">土地复垦每亩经济效益(万元)</td><td><input   value="<?php echo $this->_tpl_vars['income'][1]; ?>
" name="reclamationMoney"><input type="button" id="button_reclamationMoney" value="详情"/></td>
			<td class="tdhead">土地复垦每亩平均投资(万元)</td><td><input   value="<?php echo $this->_tpl_vars['investment'][1]; ?>
" name="reclamationPrice"><input type="button" id="button_reclamationPrice" value="详情"/></td>
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_reclamationMoney">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][1]; ?>
" name="reclamationMoney_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][2]; ?>
" name="reclamationMoney_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][3]; ?>
" name="reclamationMoney_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][4]; ?>
" name="reclamationMoney_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][5]; ?>
" name="reclamationMoney_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][6]; ?>
" name="reclamationMoney_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][7]; ?>
" name="reclamationMoney_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][8]; ?>
" name="reclamationMoney_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][9]; ?>
" name="reclamationMoney_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][10]; ?>
" name="reclamationMoney_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][11]; ?>
" name="reclamationMoney_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][12]; ?>
" name="reclamationMoney_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['income_35'][13]; ?>
" name="reclamationMoney_pre5real"></td>	  
	...
	<table align="center" style="display:none;" class="formView" id="bef3_pre5_reclamationPrice">
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][1]; ?>
" name="reclamationPrice_bef3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]-1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][2]; ?>
" name="reclamationPrice_bef2"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][3]; ?>
" name="reclamationPrice_bef1"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][4]; ?>
" name="reclamationPrice_pre1"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+1; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][5]; ?>
" name="reclamationPrice_pre1real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][6]; ?>
" name="reclamationPrice_pre2"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+2; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][7]; ?>
" name="reclamationPrice_pre2real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][8]; ?>
" name="reclamationPrice_pre3"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+3; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][9]; ?>
" name="reclamationPrice_pre3real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][10]; ?>
" name="reclamationPrice_pre4"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+4; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][11]; ?>
" name="reclamationPrice_pre4real"></td>
		</tr>
		<tr>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年规划值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][12]; ?>
" name="reclamationPrice_pre5"></td>
			<td class="tdhead"><?php echo $this->_tpl_vars['declaredata'][3]+5; ?>
年实际值</td><td><input value="<?php echo $this->_tpl_vars['investment_35'][13]; ?>
" name="reclamationPrice_pre5real"></td>	  
	...
	<table class="formView" align="center" id="public_info">
		<tr>
			<td class = 'tdtitle' colspan=4>公共捐赠(万元)<input   value="<?php echo $this->_tpl_vars['donation'][1]; ?>
" name="communityDonate"></td>
		</tr>
		<tr>	
			<td class = 'tdhead'>基础设施(万元)</td><td><input   value="<?php echo $this->_tpl_vars['donation'][2]; ?>
" name="communityDonateBase"></td>
			<td class = 'tdhead'>教育(万元)</td><td><input   value="<?php echo $this->_tpl_vars['donation'][3]; ?>
" name="communityDonateStudy"></td>
			
		</tr>
		<tr>
			<td class = 'tdhead'>渠道修建(万元)</td><td><input   value="<?php echo $this->_tpl_vars['donation'][4]; ?>
" name="communityDonateChannel"></td>
			<td class = 'tdhead'>路面拓宽硬化(万元)</td><td><input   value="<?php echo $this->_tpl_vars['donation'][5]; ?>
" name="communityDonateRoad"></td>
		</tr>
		<tr>
			<td class = 'tdhead'>备注(万元)</td><td><input   value="<?php echo $this->_tpl_vars['donation'][6]; ?>
" name="communityDonateComment"></td>
		...
		<tr>
			<td class = 'tdhead'>支农</td><td colspan=3><textarea cols="60" rows="3"  name="communityTacitFarm"><?php echo $this->_tpl_vars['support'][1]; ?>
</textarea></td>
		</tr>
		<tr>
			<td class = 'tdhead'>支教</td><td colspan=3><textarea cols="60" rows="3"  name="communityTacitTeach"><?php echo $this->_tpl_vars['support'][2]; ?>
</textarea></td>
		</tr>
		<tr>
			<td class = 'tdhead'>抗灾</td><td colspan=3><textarea cols="60" rows="3"  name="communityTacitDefeat"><?php echo $this->_tpl_vars['support'][3]; ?>
</textarea></td>
		</tr>
		<tr>
			<td class = 'tdhead'>赈灾</td><td colspan=3><textarea cols="60" rows="3"  name="communityTacitHelp"><?php echo $this->_tpl_vars['support'][4]; ?>
</textarea></td>	
		</tr>
		<tr>
			<td class = 'tdhead'>备注</td><td colspan=3><textarea cols="60" rows="3"  name="communityTacitComment"><?php echo $this->_tpl_vars['support'][5]; ?>
</textarea></td>
		</tr>
		<tr>
		...
		<tr>
			<td class = 'tdhead'>地区群众就业占矿山职工人数比重(%)</td><td colspan=3><input   value="<?php echo $this->_tpl_vars['employee'][1]; ?>
" name="communityManrate"></td>
		</tr>
		<tr>
			<td class = 'tdhead'>职工福利</td><td colspan=3><textarea cols="60" rows="3"  name="communityWelfare"><?php echo $this->_tpl_vars['employee'][2]; ?>
</textarea></td>
		</tr>
	</table>
	</div>	   
	...
	<table class="formView" align="center" id="enterprise_cul">
		<tr>
			<td class = 'tdhead'>企业宗旨</td><td colspan=2><textarea cols="60" rows="3"  name="cultureAim"><?php echo $this->_tpl_vars['corporate_culture'][1]; ?>
</textarea></td>
		</tr>
		<tr>	
			<td class = 'tdhead'>经营理念</td><td colspan=2><textarea cols="60" rows="3"  name="cultureIdea"><?php echo $this->_tpl_vars['corporate_culture'][2]; ?>
</textarea></td>
			
		</tr>
		<tr>
			<td class = 'tdhead'>企业信条</td><td colspan=2><textarea cols="60" rows="3"  name="cultureBelief"><?php echo $this->_tpl_vars['corporate_culture'][3]; ?>
</textarea></td> 
		</tr>
<!-- 		<tr>
		...
		<tr>
			<td class = 'tdhead'>组织形式</td><td colspan=2><textarea cols="60" rows="3"  name="cultureOrgan"><?php echo $this->_tpl_vars['corporate_culture'][5]; ?>
</textarea></td>
		</tr>
		<tr>
			<td class = 'tdhead'>企业之歌</td> <td colspan=2><textarea cols="60" rows="3"  name="cultureOrganMusic"><?php echo $this->_tpl_vars['corporate_culture'][6]; ?>
</textarea></td>
		</tr>
		<tr>
			<td class = 'tdhead'>歌词</td><td colspan=2><textarea cols="60" rows="3"  name="cultureOrganMusicLrc"><?php echo $this->_tpl_vars['corporate_culture'][7]; ?>
</textarea></td>
		</tr>
		<!-- <tr>
		...
		<tr>
			<td class = 'tdhead'>文体活动次数</td><td colspan=2><textarea cols="60" rows="3"  name="cultureOrganActive"><?php echo $this->_tpl_vars['corporate_culture'][9]; ?>
</textarea></td>
		</tr>
		<tr>
			<td class = 'tdhead'>企业内部刊物或报纸</td> <td colspan=2><textarea cols="60" rows="3"  name="cultureOrganPaper"><?php echo $this->_tpl_vars['corporate_culture'][10]; ?>
</textarea></td>
		</tr>
		<!-- <tr>
		...
		<tr>
			<td class = 'tdhead'>其他</td><td colspan=2><textarea cols="60" rows="3"  name="cultureOther"><?php echo $this->_tpl_vars['corporate_culture'][12]; ?>
</textarea></td>
		</tr>
	</table>
	</div>
			...
			<td>
				<table calss="formView" align="center" id="project_details">
					...
					<tr>
						...
						<td><input type="text"  value="<?php echo $this->_tpl_vars['p'][1]; ?>
" name="projectNum[]"></td>
						<td class="tdhead">工程名称</td>
						<td><input type="text"  value="<?php echo $this->_tpl_vars['p'][2]; ?>
" name="projectName[]"></td>
						<td class="tdhead">工程类型</td>
						<td>
							<select name="projectType[]">
								<option value="<?php echo $this->_tpl_vars['p'][3]; ?>
"><?php echo $this->_tpl_vars['p'][3]; ?>
</option>
					...
					<tr>
						...
						<td colspan=5>
							<textarea cols="60" rows="3" name="projectDetail[]"><?php echo $this->_tpl_vars['p'][4]; ?>
</textarea>
						</td>
					</tr>
					<tr>
						<td class="tdhead">开始年份</td>
						<td><input type="text"  value="<?php echo $this->_tpl_vars['p'][5]; ?>
" name="projectlWorktime[]"></td>
						<td class="tdhead">结束年份</td>
						<td><input type="text"  value="<?php echo $this->_tpl_vars['p'][6]; ?>
" name="projectStarttime[]"></td>
						<td class="tdhead">工程投资(万元)</td>
						<td><input type="text"  value="<?php echo $this->_tpl_vars['p'][7]; ?>
" name="projectCost[]"></td>
					</tr>					
					<tr>
						<td class="tdhead">资金筹措</td>
						<td><input type="text"  value="<?php echo $this->_tpl_vars['p'][8]; ?>
" name="projectMoney[]"></td>
						<td class="tdhead">负责部门</td>
						<td><input type="text"  value="<?php echo $this->_tpl_vars['p'][9]; ?>
" name="projectOrgan[]"></td>
					</tr>					
					<tr>
						<td class="tdhead">预期效益</td>
						<td colspan=5><textarea cols="60" rows="3" name="projectEffect[]"><?php echo $this->_tpl_vars['p'][10]; ?>
</textarea></td>
					</tr>
					<tr>
...
年完成情况</td>
						<td colspan=5>
							<textarea cols="60" rows="3" name="projectFinish1[]"><?php echo $this->_tpl_vars['p'][11]; ?>
</textarea>
						</td>
					</tr>
					<tr>
...
年完成情况</td>
						<td colspan=5>
							<textarea cols="60" rows="3" name="projectFinish2[]"><?php echo $this->_tpl_vars['p'][12]; ?>
</textarea>
						</td>
					</tr>
					<tr>
...
年完成情况</td>
						<td colspan=5>
							<textarea cols="60" rows="3" name="projectFinish3[]"><?php echo $this->_tpl_vars['p'][13]; ?>
</textarea>
						</td>
					</tr>
					<tr>
...
年完成情况</td>
						<td colspan=5>
							<textarea cols="60" rows="3" name="projectFinish4[]"><?php echo $this->_tpl_vars['p'][14]; ?>
</textarea>
						</td>
					</tr>
					<tr>
...
年完成情况</td>
						<td colspan=5>
							<textarea cols="60" rows="3" name="projectFinish5[]"><?php echo $this->_tpl_vars['p'][15]; ?>
</textarea>
						</td>
					</tr>
	...
	<div id="tabs-12"><!--审核意见-->
	 <table class="formView" align="center" id="audit_info" width='100%'>
		<tr>
			<td class = 'tdhead'>国土资源部审核意见</td><td colspan=3><textarea cols="60" rows="3"  name="auditNation"><?php echo $this->_tpl_vars['auditdataArray'][0]->auditNation; ?>
</textarea></td>
...
"   name="auditNationTime"></td>
                ...
                <tr>
			<td class = 'tdhead'>省级国土资源主管部门审核意见</td><td colspan=3 ><textarea cols="60" rows="3"  name="auditPlace"><?php echo $this->_tpl_vars['auditdataArray'][0]->auditPlace; ?>
</textarea></td>
...
"   name="auditPlaceTime"></td>
		...
		<tr>
			<td class = 'tdhead'>行业协会审核意见</td><td colspan=3 ><textarea cols="60" rows="3"  name="auditIndustry"><?php echo $this->_tpl_vars['auditdataArray'][0]->auditIndustry; ?>
</textarea></td>
...
"   name="auditIndustryTime"></td>
		...
		<tr>
			<td class = 'tdhead'>市级国土资源主管部门审核意见</td><td colspan=3 ><textarea cols="60" rows="3"  name="auditShi"><?php echo $this->_tpl_vars['auditdataArray'][0]->auditShi; ?>
</textarea></td>
			<td class = 'tdhead'>审核时间</td><td><input class="datepicker" width="90%" name="auditShiTime"></td>
		</tr>
		<tr>
			<td class = 'tdhead'>县级国土资源主管部门审核意见</td><td colspan=3 ><textarea cols="60" rows="3"  name="auditXian"><?php echo $this->_tpl_vars['auditdataArray'][0]->auditXian; ?>
</textarea></td>
