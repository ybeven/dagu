<?php /* Smarty version 2.6.26, created on 2014-11-12 03:01:52
         compiled from predata/ListExcelDetailsYangling.tpl */ ?>
...
<form name="form" action="/predata/SavePreData/11" method="post">
...
" name="leitong[]" ></td>
	...
	<input type="button" onclick="window.location='/predata/AddPreData11'" value="返回" />
</form>
