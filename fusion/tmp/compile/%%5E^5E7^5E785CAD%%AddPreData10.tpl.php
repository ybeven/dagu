<?php /* Smarty version 2.6.26, created on 2014-11-12 02:57:57
         compiled from predata/AddPreData10.tpl */ ?>
...
'; ?>
	...
	// alert(x);
	document.getElementById("form").action="/predata/UploadeExcelData10/"+x;
...
<form name="form" id="form" action="/predata/UploadeExcelData10" method="post" enctype="multipart/form-data">
