<?php /* Smarty version 2.6.26, created on 2014-11-12 10:47:01
         compiled from predata/AddPreData11.tpl */ ?>
...
'; ?>
	...
	// alert(x);
	document.getElementById("form").action="/predata/UploadeExcelData11/"+x;
...
<form name="form" id="form" action="/predata/UploadeExcelData11" method="post" enctype="multipart/form-data">
