<?php /* Smarty version 2.6.26, created on 2014-11-13 13:34:48
         compiled from system/login.tpl */ ?>
...
<div id='containerL'>
	<div id='login'>
    		<div id='inputbox'>
			<form id="login_form" method="post" action="/system/doLogin/<?php echo $this->_tpl_vars['jumpTo']; ?>
">
			...
			<div id="login_notice"><?php if ($this->_tpl_vars['notice']): ?><?php echo $this->_tpl_vars['notice']; ?>
<?php endif; ?></div>
		</div>
		<div id='login-button'>
