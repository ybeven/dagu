<?php /* Smarty version 2.6.26, created on 2014-05-18 02:35:19
         compiled from minedata/AddFiles.tpl */ ?>
...
<form name="form" action="/minedata/files/<?php echo $this->_tpl_vars['mineid']; ?>
...
">下载</a></td>
			<?php if ($this->_tpl_vars['QuanXian'] != 1): ?><td><a href="/minedata/DeleteFiles/<?php echo $this->_tpl_vars['data'][3]; ?>
">删除</a></td><?php endif; ?>
        </tr>           
...
?>
	<?php if ($this->_tpl_vars['data'][2] == '2'): ?>
		<tr>
            <td><?php if ($this->_tpl_vars['data'][5] == "image/jpeg"): ?><img src="http://localhost/uploadDir/<?php echo $this->_tpl_vars['data'][1]; ?>
/<?php echo $this->_tpl_vars['data'][0]; ?>
" width="80%" style="height:60px;width:80px"><?php endif; ?><?php echo $this->_tpl_vars['data'][0]; ?>
</td>
			<td><?php echo $this->_tpl_vars['data'][1]; ?>
</td>
			<td><?php echo $this->_tpl_vars['data'][5]; ?>
...
<table class="listView" align="center" width="100%">
    ...
    foreach ($_from as $this->_tpl_vars['data']):
?>
	<?php if ($this->_tpl_vars['data'][2] == '3'): ?>
		<tr>
            <td><img src="http://localhost/uploadDir/<?php echo $this->_tpl_vars['data'][1]; ?>
/<?php echo $this->_tpl_vars['data'][0]; ?>
" width="80%" style="height:60px;width:80px"></td>
...
<table class="listView" align="center" width="100%">
    ...
    foreach ($_from as $this->_tpl_vars['data']):
?>
	<?php if ($this->_tpl_vars['data'][2] == '4'): ?>
		<tr>
            <td><img src="http://localhost/uploadDir/<?php echo $this->_tpl_vars['data'][1]; ?>
/<?php echo $this->_tpl_vars['data'][0]; ?>
" width="80%" style="height:60px;width:80px"></td>
...
<table class="listView" align="center" width="100%">
    ...
    foreach ($_from as $this->_tpl_vars['data']):
?>
	<?php if ($this->_tpl_vars['data'][2] == '5'): ?>
		<tr>
            <td><img src="http://localhost/uploadDir/<?php echo $this->_tpl_vars['data'][1]; ?>
/<?php echo $this->_tpl_vars['data'][0]; ?>
" width="80%" style="height:60px;width:80px"></td>
...
<table class="listView" align="center" width="100%">
    ...
    foreach ($_from as $this->_tpl_vars['data']):
?>
	<?php if ($this->_tpl_vars['data'][2] == '6'): ?>
		<tr>
            <td><img src="http://localhost/uploadDir/<?php echo $this->_tpl_vars['data'][1]; ?>
/<?php echo $this->_tpl_vars['data'][0]; ?>
" width="80%" style="height:60px;width:80px"></td>
...
<table class="listView" align="center" width="100%">
    ...
    foreach ($_from as $this->_tpl_vars['data']):
?>
	<?php if ($this->_tpl_vars['data'][2] == '7'): ?>
		<tr>
            <td><img src="http://localhost/uploadDir/<?php echo $this->_tpl_vars['data'][1]; ?>
/<?php echo $this->_tpl_vars['data'][0]; ?>
" width="80%" style="height:60px;width:80px"></td>
...
<?php if ($this->_tpl_vars['QuanXian'] != 1): ?><input type="submit" name="submit" value="导入文件"><?php endif; ?>
