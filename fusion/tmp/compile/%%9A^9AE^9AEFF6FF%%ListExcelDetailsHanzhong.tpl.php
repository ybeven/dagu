<?php /* Smarty version 2.6.26, created on 2014-11-12 02:57:54
         compiled from predata/ListExcelDetailsHanzhong.tpl */ ?>
...
<form name="form" action="/predata/SavePreData/10" method="post">
...
" name="leitong[]" ></td>
	...
	<input type="button" onclick="window.location='/predata/AddPreData10'" value="返回" />
</form>
