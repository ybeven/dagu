<?php /* Smarty version 2.6.26, created on 2014-11-12 02:55:08
         compiled from predata/ListExcelDetailsXianyang.tpl */ ?>
...
<form name="form" action="/predata/SavePreData/2" method="post">
...
" name="leitong[]" ></td>
	...
	<input type="button" onclick="window.location='/predata/AddPreData2'" value="返回" />
</form>
