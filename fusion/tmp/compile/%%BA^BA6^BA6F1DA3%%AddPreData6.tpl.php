<?php /* Smarty version 2.6.26, created on 2014-11-12 02:57:33
         compiled from predata/AddPreData6.tpl */ ?>
...
'; ?>
	...
	// alert(x);
	document.getElementById("form").action="/predata/UploadeExcelData6/"+x;
...
<form name="form" id="form" action="/predata/UploadeExcelData6" method="post" enctype="multipart/form-data">
