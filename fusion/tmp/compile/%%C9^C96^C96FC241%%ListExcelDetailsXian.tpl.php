<?php /* Smarty version 2.6.26, created on 2014-11-12 02:51:09
         compiled from predata/ListExcelDetailsXian.tpl */ ?>
...
<form name="form" action="/predata/SavePreData/1" method="post">
...
" name="leitong[]" ></td>
	...
	<input type="button" onclick="window.location='/predata/AddPreData1'" value="返回" />
</form>
