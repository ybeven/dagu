<?php /* Smarty version 2.6.26, created on 2014-12-10 12:19:26
         compiled from predata/SearchPreDataDetails2.tpl */ ?>
<div class='tablebox'>
<form name="form" action="/predata/SearchPreDataDetails2/0" method="post">
		<tr>
			<th>身份证号</th><td><input type="text" name="idcard" /></td>
		</tr>
		<tr>
			<th>考试科目</th><td><input type="text" name="course" /></td>
		</tr>
		<tr>
