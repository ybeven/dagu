<?php /* Smarty version 2.6.26, created on 2014-11-25 16:53:09
         compiled from predata/AddPreData4.tpl */ ?>
...
'; ?>
	...
	// alert(x);
	document.getElementById("form").action="/predata/UploadeExcelData4/"+x;
...
<form name="form" id="form" action="/predata/UploadeExcelData4" method="post" enctype="multipart/form-data">
