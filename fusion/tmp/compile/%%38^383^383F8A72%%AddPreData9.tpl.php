<?php /* Smarty version 2.6.26, created on 2014-11-12 10:46:59
         compiled from predata/AddPreData9.tpl */ ?>
...
'; ?>
	...
	// alert(x);
	document.getElementById("form").action="/predata/UploadeExcelData9/"+x;
...
<form name="form" id="form" action="/predata/UploadeExcelData9" method="post" enctype="multipart/form-data">
