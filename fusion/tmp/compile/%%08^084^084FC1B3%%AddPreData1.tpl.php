<?php /* Smarty version 2.6.26, created on 2014-11-26 18:31:48
         compiled from predata/AddPreData1.tpl */ ?>
...
'; ?>
	...
	// alert(x);
	document.getElementById("form").action="/predata/UploadeExcelData1/"+x;
...
<form name="form" id="form" action="/predata/UploadeExcelData1" method="post" enctype="multipart/form-data">
