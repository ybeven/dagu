<?php /* Smarty version 2.6.26, created on 2014-05-18 01:59:53
         compiled from gragh/times.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'gragh/times.tpl', 258, false),)), $this); ?>
	 ...
	 <form id="picture" method="post" action="times">
			<table class="formView" align="center">
				<tr>
					...
					<td>
						<select name="syear">
						<option value="15" <?php echo $this->_tpl_vars['selected15']; ?>
><?php echo $this->_tpl_vars['year']+5; ?>
</option>
						<option value="14" <?php echo $this->_tpl_vars['selected14']; ?>
><?php echo $this->_tpl_vars['year']+4; ?>
</option>
						<option value="13" <?php echo $this->_tpl_vars['selected13']; ?>
><?php echo $this->_tpl_vars['year']+3; ?>
</option>
						<option value="12" <?php echo $this->_tpl_vars['selected12']; ?>
><?php echo $this->_tpl_vars['year']+2; ?>
</option>
...
>重点工程总投资</option>
 ...
 id="positionx_text"><?php echo ((is_array($_tmp=$this->_tpl_vars['positionx'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 9, "...") : smarty_modifier_truncate($_tmp, 9, "...")); ?>
</option>
						</select>	
...
<caption><?php echo $this->_tpl_vars['syear']; ?>
<?php echo $this->_tpl_vars['indexname']; ?>
统计</caption>
<?php if ($this->_tpl_vars['disapearTable'] == 9): ?>
 <tr>
