<?php /* Smarty version 2.6.26, created on 2014-11-12 06:20:11
         compiled from predata/AddPreData8.tpl */ ?>
...
'; ?>
	...
	// alert(x);
	document.getElementById("form").action="/predata/UploadeExcelData8/"+x;
...
<form name="form" id="form" action="/predata/UploadeExcelData8" method="post" enctype="multipart/form-data">
