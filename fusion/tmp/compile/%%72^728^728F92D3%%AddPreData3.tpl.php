<?php /* Smarty version 2.6.26, created on 2014-11-12 02:57:32
         compiled from predata/AddPreData3.tpl */ ?>
...
'; ?>
	...
	// alert(x);
	document.getElementById("form").action="/predata/UploadeExcelData3/"+x;
...
<form name="form" id="form" action="/predata/UploadeExcelData3" method="post" enctype="multipart/form-data">
