<?php /* Smarty version 2.6.26, created on 2014-11-12 10:17:54
         compiled from predata/AddPreData2.tpl */ ?>
...
'; ?>
	...
	// alert(x);
	document.getElementById("form").action="/predata/UploadeExcelData2/"+x;
...
<form name="form" id="form" action="/predata/UploadeExcelData2" method="post" enctype="multipart/form-data">
