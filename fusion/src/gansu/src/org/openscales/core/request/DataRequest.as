package org.openscales.core.request {
	...
	public class DataRequest extends AbstractRequest {
		 ...
		 */
		public function DataRequest(url:String, onComplete:Function=null, proxy:String = null, security:ISecurity = null, onFailure:Function=null,bodyContent:String="") {
			/* try {
			...
			SendDataRequest(url,bodyContent,onComplete, proxy, security, onFailure);
		}
		private function SendDataRequest(url:String,bodyContent:String="", onComplete:Function=null, proxy:String = null, security:ISecurity = null, onFailure:Function=null):void {
			try {
				this._loader = new Loader();
				this._onComplete = onComplete;
				this._onFailure = onFailure;
				...
				var loaderContext:LoaderContext = new LoaderContext();
				loaderContext.checkPolicyFile = true;
				var urlRequest:URLRequest=new URLRequest(finalUrl);
				if(bodyContent!=null&&bodyContent.length>0)
				{
					urlRequest.method=URLRequestMethod.POST;
					urlRequest.data=bodyContent;
