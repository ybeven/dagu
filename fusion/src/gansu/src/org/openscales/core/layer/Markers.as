package org.openscales.core.layer
{
	...
	public class Markers extends Layer
	{
	    ...
	    public function addMarker(marker:MarkerEX):void {
	    ...
	    public function removeMarker(marker:MarkerEX):void {
	     ...
	     * @param marker
	     */
	    public function drawMarker(marker:MarkerEX):void {
	    ...
	    public function bringToFront(marker:MarkerEX):void {
	    ...
	    public function getDataExtent():Bounds {
        	...
        	if ( this.markers && (this.markers.length > 0)) {
            	...
            	for(var i:int=0; i < this.markers.length; i++) {
                	var marker:MarkerEX = this.markers[i];
