package org.openscales.core.feature
{
	...
	public class MarkerFeature
	{
	    ...
	    private var _marker:MarkerEX = null;
		 ...
		 * @param data
		 */
		public function MarkerFeature(layer:Layer, lonlat:LonLat, data:Object):void {
			this.layer = layer;
	        this.lonlat = lonlat;
	        if (data != null){
	        	this.data = data;
		 ...
		 */
		public function createMarker():MarkerEX {
			var marker:MarkerEX = null;
	        
	        if (this.lonlat != null) {
	            this._marker = new MarkerEX();
		...
		public function createPopup(closeBox:Boolean=true):Popup {
			//comment by gmq for it has error
			/* if (this.lonlat != null) {
