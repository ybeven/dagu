...
function UploadeExcelData10($pici,$notice=null){
	global $smarty;
	needLogin();
...
/********Excel update to data********/
    ...
    $crumb->visitNewPage("汉中考点成绩导入" , "/predata/AddPreData10" , true);	    
	...
	$smarty->displaymother('predata/ListExcelDetailsHanzhong.tpl');
}
?>