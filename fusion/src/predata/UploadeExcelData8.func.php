...
function UploadeExcelData8($pici,$notice=null){
	global $smarty;
	needLogin();
...
/********Excel update to data********/
    ...
    $crumb->visitNewPage("渭南考点成绩导入" , "/predata/AddPreData8" , true);	    
	...
	$smarty->displaymother('predata/ListExcelDetailsWeinan.tpl');
}
?>