...
function UploadeExcelData6($pici,$notice=null){
	global $smarty;
	needLogin();
...
/********Excel update to data********/
    ...
    $crumb->visitNewPage("榆林考点成绩导入" , "/predata/AddPreData6" , true);	    
	...
	$smarty->displaymother('predata/ListExcelDetailsYulin.tpl');
}
?>