...
function UploadeExcelData7($pici,$notice=null){
	global $smarty;
	needLogin();
...
/********Excel update to data********/
    ...
    $crumb->visitNewPage("商洛考点成绩导入" , "/predata/AddPreData7" , true);	    
	...
	$smarty->displaymother('predata/ListExcelDetailsShangluo.tpl');
}
?>