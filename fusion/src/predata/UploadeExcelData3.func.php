...
function UploadeExcelData3($pici,$notice=null){
	global $smarty;
	needLogin();
...
/********Excel update to data********/
    ...
    $crumb->visitNewPage("宝鸡考点成绩导入" , "/predata/AddPreData3" , true);	    
	...
	$smarty->displaymother('predata/ListExcelDetailsBaoji.tpl');
}
?>