...
function UploadeExcelData5($pici,$notice=null){
	global $smarty;
	needLogin();
...
/********Excel update to data********/
    ...
    $crumb->visitNewPage("延安考点成绩导入" , "/predata/AddPreData5" , true);	    
	...
	$smarty->displaymother('predata/ListExcelDetailsYanan.tpl');
}
?>