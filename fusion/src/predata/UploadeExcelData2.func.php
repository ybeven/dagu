...
function UploadeExcelData2($pici,$notice=null){
	global $smarty;
	needLogin();
...
/********Excel update to data********/
    ...
    $crumb->visitNewPage("咸阳考点成绩导入" , "/predata/AddPreData2" , true);	    
	...
	$smarty->displaymother('predata/ListExcelDetailsXianyang.tpl');
}
?>