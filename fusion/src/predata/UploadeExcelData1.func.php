...
function UploadeExcelData1($pici,$notice=null){
	global $smarty;
	needLogin();
...
/********Excel update to data********/
    ...
    $crumb->visitNewPage("西安考点成绩导入" , "/predata/AddPreData1" , true);	    
	...
	$smarty->displaymother('predata/ListExcelDetailsXian.tpl');
}
?>