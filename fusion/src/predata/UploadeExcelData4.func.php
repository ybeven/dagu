...
function UploadeExcelData4($pici,$notice=null){
	global $smarty;
	needLogin();
...
/********Excel update to data********/
    ...
    $crumb->visitNewPage("铜川考点成绩导入" , "/predata/AddPreData4" , true);	    
	...
	$smarty->displaymother('predata/ListExcelDetailsTongchuan.tpl');
}
?>