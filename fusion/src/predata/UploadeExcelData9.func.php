...
function UploadeExcelData9($pici,$notice=null){
	global $smarty;
	needLogin();
...
/********Excel update to data********/
    ...
    $crumb->visitNewPage("安康考点成绩导入" , "/predata/AddPreData9" , true);	    
	...
	$smarty->displaymother('predata/ListExcelDetailsAnkang.tpl');
}
?>