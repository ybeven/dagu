<?php
function QCTableZBsearch($notice = null){
	global $smarty;
	needLogin();
	...
	$objActiveSheet->setCellValue('A2', ' '.$date2.'  '.$workID[0]->name);
	$objActiveSheet->getColumnDimension('A')->setWidth(25);
	...
	$crumb->visitNewPage("查看销售报表" , "" , true);
