...
////////////////////////////////////////////////////////////////////////////////////
	...
	if($task->calculateMethod == "重车-空车")
        {$smarty->display('QC/PrintCostJS.tpl');}
	elseif($task->calculateMethod == "质量流量计")
	{$smarty->display('QC/PrintCostJS2.tpl');}
